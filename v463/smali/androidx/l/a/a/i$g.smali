...
.method public a(Landroid/graphics/ColorFilter;)Landroid/graphics/Paint;
    ...
    .line 1055
    invoke-virtual {p0}, Landroidx/l/a/a/i$g;->a()Z
    ...
    .line 1059
    :cond_0
    iget-object v0, p0, Landroidx/l/a/a/i$g;->l:Landroid/graphics/Paint;
    ...
    iput-object v0, p0, Landroidx/l/a/a/i$g;->l:Landroid/graphics/Paint;
    ...
    invoke-virtual {v1}, Landroidx/l/a/a/i$f;->getRootAlpha()I
    ...
    .line 1065
    iget-object p1, p0, Landroidx/l/a/a/i$g;->l:Landroid/graphics/Paint;
...
.method public a(II)V
    ...
    invoke-virtual {v1, v0, p1, p2, v2}, Landroidx/l/a/a/i$f;->a(Landroid/graphics/Canvas;IILandroid/graphics/ColorFilter;)V
...
.method public a(Landroid/graphics/Canvas;Landroid/graphics/ColorFilter;Landroid/graphics/Rect;)V
    ...
    .line 1043
    invoke-virtual {p0, p2}, Landroidx/l/a/a/i$g;->a(Landroid/graphics/ColorFilter;)Landroid/graphics/Paint;
...
.method public a([I)Z
    ...
    invoke-virtual {v0, p1}, Landroidx/l/a/a/i$f;->a([I)Z

    move-result p1

    .line 1139
    iget-boolean v0, p0, Landroidx/l/a/a/i$g;->k:Z

    or-int/2addr v0, p1

    iput-boolean v0, p0, Landroidx/l/a/a/i$g;->k:Z
...
.method public b(II)V
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/l/a/a/i$g;->c(II)Z
    ...
    iput-object p1, p0, Landroidx/l/a/a/i$g;->f:Landroid/graphics/Bitmap;

    const/4 p1, 0x1

    .line 1078
    iput-boolean p1, p0, Landroidx/l/a/a/i$g;->k:Z
...
.method public b()Z
    ...
    iget-object v0, p0, Landroidx/l/a/a/i$g;->g:Landroid/content/res/ColorStateList;

    iget-object v1, p0, Landroidx/l/a/a/i$g;->c:Landroid/content/res/ColorStateList;

    if-ne v0, v1, :cond_0

    iget-object v0, p0, Landroidx/l/a/a/i$g;->h:Landroid/graphics/PorterDuff$Mode;

    iget-object v1, p0, Landroidx/l/a/a/i$g;->d:Landroid/graphics/PorterDuff$Mode;

    if-ne v0, v1, :cond_0

    iget-boolean v0, p0, Landroidx/l/a/a/i$g;->j:Z

    iget-boolean v1, p0, Landroidx/l/a/a/i$g;->e:Z

    if-ne v0, v1, :cond_0

    iget v0, p0, Landroidx/l/a/a/i$g;->i:I
...
.method public c()V
    ...
    .line 1105
    iget-object v0, p0, Landroidx/l/a/a/i$g;->c:Landroid/content/res/ColorStateList;

    iput-object v0, p0, Landroidx/l/a/a/i$g;->g:Landroid/content/res/ColorStateList;

    .line 1106
    iget-object v0, p0, Landroidx/l/a/a/i$g;->d:Landroid/graphics/PorterDuff$Mode;

    iput-object v0, p0, Landroidx/l/a/a/i$g;->h:Landroid/graphics/PorterDuff$Mode;
    ...
    iput v0, p0, Landroidx/l/a/a/i$g;->i:I

    .line 1108
    iget-boolean v0, p0, Landroidx/l/a/a/i$g;->e:Z

    iput-boolean v0, p0, Landroidx/l/a/a/i$g;->j:Z
...
.method public c(II)Z
    ...
    iget-object p1, p0, Landroidx/l/a/a/i$g;->f:Landroid/graphics/Bitmap;
