...
.method public constructor <init>(Landroidx/appcompat/widget/AppCompatSpinner;Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p2, p0, Landroidx/appcompat/widget/AppCompatSpinner$b;->d:Landroid/graphics/Rect;

    .line 725
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/AppCompatSpinner$b;->setAnchorView(Landroid/view/View;)V

    const/4 p2, 0x1

    .line 726
    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/AppCompatSpinner$b;->setModal(Z)V

    const/4 p2, 0x0

    .line 727
    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/AppCompatSpinner$b;->setPromptPosition(I)V
    ...
    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/AppCompatSpinner$b;->setOnItemClickListener(Landroid/widget/AdapterView$OnItemClickListener;)V
...
.method a(Landroid/view/View;)Z
    ...
    .line 849
    invoke-static {p1}, Landroidx/core/h/r;->z(Landroid/view/View;)Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner$b;->d:Landroid/graphics/Rect;
...
.method b()V
    ...
    .line 758
    invoke-virtual {p0}, Landroidx/appcompat/widget/AppCompatSpinner$b;->getBackground()Landroid/graphics/drawable/Drawable;
    ...
    .line 761
    iget-object v1, p0, Landroidx/appcompat/widget/AppCompatSpinner$b;->b:Landroidx/appcompat/widget/AppCompatSpinner;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/AppCompatSpinner$b;->b:Landroidx/appcompat/widget/AppCompatSpinner;
    ...
    .line 770
    iget-object v3, p0, Landroidx/appcompat/widget/AppCompatSpinner$b;->b:Landroidx/appcompat/widget/AppCompatSpinner;
    ...
    .line 771
    iget-object v4, p0, Landroidx/appcompat/widget/AppCompatSpinner$b;->b:Landroidx/appcompat/widget/AppCompatSpinner;
    ...
    iget-object v5, p0, Landroidx/appcompat/widget/AppCompatSpinner$b;->a:Landroid/widget/ListAdapter;
    ...
    .line 774
    iget-object v5, p0, Landroidx/appcompat/widget/AppCompatSpinner$b;->b:Landroidx/appcompat/widget/AppCompatSpinner;
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/AppCompatSpinner$b;->b:Landroidx/appcompat/widget/AppCompatSpinner;
    ...
    invoke-virtual {p0, v4}, Landroidx/appcompat/widget/AppCompatSpinner$b;->setContentWidth(I)V
    ...
    .line 787
    invoke-virtual {p0}, Landroidx/appcompat/widget/AppCompatSpinner$b;->getWidth()I
    ...
    .line 791
    :goto_3
    invoke-virtual {p0, v1}, Landroidx/appcompat/widget/AppCompatSpinner$b;->setHorizontalOffset(I)V
...
.method public show()V
    ...
    .line 796
    invoke-virtual {p0}, Landroidx/appcompat/widget/AppCompatSpinner$b;->isShowing()Z
    ...
    .line 800
    invoke-virtual {p0, v1}, Landroidx/appcompat/widget/AppCompatSpinner$b;->setInputMethodMode(I)V

    .line 801
    invoke-super {p0}, Landroidx/appcompat/widget/ListPopupWindow;->show()V

    .line 802
    invoke-virtual {p0}, Landroidx/appcompat/widget/AppCompatSpinner$b;->getListView()Landroid/widget/ListView;
    ...
    invoke-virtual {p0, v1}, Landroidx/appcompat/widget/AppCompatSpinner$b;->setSelection(I)V
    ...
    invoke-virtual {p0, v0}, Landroidx/appcompat/widget/AppCompatSpinner$b;->setOnDismissListener(Landroid/widget/PopupWindow$OnDismissListener;)V
