...
.method constructor <init>(Landroid/widget/TextView;)V
    ...
    .line 60
    iput v0, p0, Landroidx/appcompat/widget/i;->i:I
...
.method private static a(Landroid/content/Context;Landroidx/appcompat/widget/AppCompatDrawableManager;I)Landroidx/appcompat/widget/p;
    .locals 0
...
.method private a(Landroid/content/Context;Landroidx/appcompat/widget/TintTypedArray;)V
    .locals 4

    .line 242
    sget v0, Landroidx/appcompat/a$j;->TextAppearance_android_textStyle:I

    iget v1, p0, Landroidx/appcompat/widget/i;->i:I
    ...
    .line 284
    iput-boolean v1, p0, Landroidx/appcompat/widget/i;->k:Z
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/i;->j:Landroid/graphics/Typeface;
    ...
    .line 246
    iput-object v0, p0, Landroidx/appcompat/widget/i;->j:Landroid/graphics/Typeface;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/i;->a:Landroid/widget/TextView;

    invoke-direct {p1, v3}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    .line 252
    new-instance v3, Landroidx/appcompat/widget/i$1;

    invoke-direct {v3, p0, p1}, Landroidx/appcompat/widget/i$1;-><init>(Landroidx/appcompat/widget/i;Ljava/lang/ref/WeakReference;)V

    .line 265
    :try_start_0
    iget p1, p0, Landroidx/appcompat/widget/i;->i:I

    invoke-virtual {p2, v0, p1, v3}, Landroidx/appcompat/widget/TintTypedArray;->getFont(IILandroidx/core/a/a/f$a;)Landroid/graphics/Typeface;
    ...
    :cond_8
    :goto_3
    iget-object p1, p0, Landroidx/appcompat/widget/i;->j:Landroid/graphics/Typeface;
    ...
    .line 276
    iget p2, p0, Landroidx/appcompat/widget/i;->i:I
...
.method private a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/p;)V
    ...
    invoke-static {p1, p2, v0}, Landroidx/appcompat/widget/AppCompatDrawableManager;->tintDrawable(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/p;[I)V
...
.method private b(IF)V
    ...
    .line 418
    iget-object v0, p0, Landroidx/appcompat/widget/i;->h:Landroidx/appcompat/widget/j;
...
.method a()V
    ...
    .line 352
    iget-object v0, p0, Landroidx/appcompat/widget/i;->b:Landroidx/appcompat/widget/p;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/i;->c:Landroidx/appcompat/widget/p;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroidx/appcompat/widget/i;->d:Landroidx/appcompat/widget/p;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroidx/appcompat/widget/i;->e:Landroidx/appcompat/widget/p;
    ...
    iget-object v4, p0, Landroidx/appcompat/widget/i;->b:Landroidx/appcompat/widget/p;

    invoke-direct {p0, v3, v4}, Landroidx/appcompat/widget/i;->a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/p;)V
    ...
    iget-object v4, p0, Landroidx/appcompat/widget/i;->c:Landroidx/appcompat/widget/p;
    ...
    iget-object v4, p0, Landroidx/appcompat/widget/i;->d:Landroidx/appcompat/widget/p;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/i;->e:Landroidx/appcompat/widget/p;

    invoke-direct {p0, v0, v3}, Landroidx/appcompat/widget/i;->a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/p;)V
    ...
    .line 361
    iget-object v0, p0, Landroidx/appcompat/widget/i;->f:Landroidx/appcompat/widget/p;

    if-nez v0, :cond_2

    iget-object v0, p0, Landroidx/appcompat/widget/i;->g:Landroidx/appcompat/widget/p;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/i;->f:Landroidx/appcompat/widget/p;

    invoke-direct {p0, v2, v3}, Landroidx/appcompat/widget/i;->a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/p;)V

    .line 364
    aget-object v0, v0, v1

    iget-object v1, p0, Landroidx/appcompat/widget/i;->g:Landroidx/appcompat/widget/p;

    invoke-direct {p0, v0, v1}, Landroidx/appcompat/widget/i;->a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/p;)V
...
.method a(IF)V
    ...
    .line 399
    invoke-virtual {p0}, Landroidx/appcompat/widget/i;->c()Z
    ...
    .line 400
    invoke-direct {p0, p1, p2}, Landroidx/appcompat/widget/i;->b(IF)V
...
.method a(Landroid/content/Context;I)V
    ...
    invoke-virtual {p0, v0}, Landroidx/appcompat/widget/i;->a(Z)V
    ...
    .line 330
    iget-object v2, p0, Landroidx/appcompat/widget/i;->a:Landroid/widget/TextView;
    ...
    .line 340
    :cond_2
    invoke-direct {p0, p1, p2}, Landroidx/appcompat/widget/i;->a(Landroid/content/Context;Landroidx/appcompat/widget/TintTypedArray;)V
    ...
    .line 343
    iget-object p2, p0, Landroidx/appcompat/widget/i;->a:Landroid/widget/TextView;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    .line 71
    iget-object v3, v0, Landroidx/appcompat/widget/i;->a:Landroid/widget/TextView;
    ...
    .line 80
    invoke-static {v3, v4, v9}, Landroidx/appcompat/widget/i;->a(Landroid/content/Context;Landroidx/appcompat/widget/AppCompatDrawableManager;I)Landroidx/appcompat/widget/p;

    move-result-object v9

    iput-object v9, v0, Landroidx/appcompat/widget/i;->b:Landroidx/appcompat/widget/p;
    ...
    iput-object v9, v0, Landroidx/appcompat/widget/i;->c:Landroidx/appcompat/widget/p;
    ...
    iput-object v9, v0, Landroidx/appcompat/widget/i;->d:Landroidx/appcompat/widget/p;
    ...
    iput-object v9, v0, Landroidx/appcompat/widget/i;->e:Landroidx/appcompat/widget/p;
    ...
    iput-object v9, v0, Landroidx/appcompat/widget/i;->f:Landroidx/appcompat/widget/p;
    ...
    iput-object v4, v0, Landroidx/appcompat/widget/i;->g:Landroidx/appcompat/widget/p;
    ...
    .line 112
    iget-object v4, v0, Landroidx/appcompat/widget/i;->a:Landroid/widget/TextView;
    ...
    .line 128
    :goto_0
    invoke-direct {v0, v3, v7}, Landroidx/appcompat/widget/i;->a(Landroid/content/Context;Landroidx/appcompat/widget/TintTypedArray;)V
    ...
    .line 173
    iget-object v9, v0, Landroidx/appcompat/widget/i;->a:Landroid/widget/TextView;
    ...
    .line 181
    iget-object v7, v0, Landroidx/appcompat/widget/i;->a:Landroid/widget/TextView;
    ...
    .line 190
    invoke-virtual {v0, v11}, Landroidx/appcompat/widget/i;->a(Z)V

    .line 192
    :cond_14
    iget-object v4, v0, Landroidx/appcompat/widget/i;->j:Landroid/graphics/Typeface;

    if-eqz v4, :cond_15

    .line 193
    iget-object v5, v0, Landroidx/appcompat/widget/i;->a:Landroid/widget/TextView;

    iget v7, v0, Landroidx/appcompat/widget/i;->i:I

    invoke-virtual {v5, v4, v7}, Landroid/widget/TextView;->setTypeface(Landroid/graphics/Typeface;I)V

    .line 196
    :cond_15
    iget-object v4, v0, Landroidx/appcompat/widget/i;->h:Landroidx/appcompat/widget/j;
    ...
    .line 200
    iget-object v2, v0, Landroidx/appcompat/widget/i;->h:Landroidx/appcompat/widget/j;

    invoke-virtual {v2}, Landroidx/appcompat/widget/j;->a()I
    ...
    .line 208
    iget-object v2, v0, Landroidx/appcompat/widget/i;->a:Landroid/widget/TextView;
    ...
    iget-object v5, v0, Landroidx/appcompat/widget/i;->h:Landroidx/appcompat/widget/j;

    .line 210
    invoke-virtual {v5}, Landroidx/appcompat/widget/j;->d()I

    move-result v5

    iget-object v7, v0, Landroidx/appcompat/widget/i;->h:Landroidx/appcompat/widget/j;

    .line 211
    invoke-virtual {v7}, Landroidx/appcompat/widget/j;->b()I
    ...
    .line 231
    iget-object v1, v0, Landroidx/appcompat/widget/i;->a:Landroid/widget/TextView;
...
.method a(Ljava/lang/ref/WeakReference;Landroid/graphics/Typeface;)V
    ...
    .line 304
    iget-boolean v0, p0, Landroidx/appcompat/widget/i;->k:Z

    if-eqz v0, :cond_0

    .line 305
    iput-object p2, p0, Landroidx/appcompat/widget/i;->j:Landroid/graphics/Typeface;
...
.method b()V
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/j;->f()V
