...
.field mDropDownList:Landroidx/appcompat/widget/k;
...
.field private final mHideSelector:Landroidx/appcompat/widget/ListPopupWindow$a;
...
.field final mResizePopupRunnable:Landroidx/appcompat/widget/ListPopupWindow$e;

.field private final mScrollListener:Landroidx/appcompat/widget/ListPopupWindow$c;

.field private mShowDropDownRunnable:Ljava/lang/Runnable;

.field private final mTempRect:Landroid/graphics/Rect;

.field private final mTouchInterceptor:Landroidx/appcompat/widget/ListPopupWindow$d;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object v2, p0, Landroidx/appcompat/widget/ListPopupWindow;->mResizePopupRunnable:Landroidx/appcompat/widget/ListPopupWindow$e;
    ...
    iput-object v2, p0, Landroidx/appcompat/widget/ListPopupWindow;->mTouchInterceptor:Landroidx/appcompat/widget/ListPopupWindow$d;
    ...
    iput-object v2, p0, Landroidx/appcompat/widget/ListPopupWindow;->mScrollListener:Landroidx/appcompat/widget/ListPopupWindow$c;
    ...
    iput-object v2, p0, Landroidx/appcompat/widget/ListPopupWindow;->mHideSelector:Landroidx/appcompat/widget/ListPopupWindow$a;
    ...
    invoke-direct {v1, p1, p2, p3, p4}, Landroidx/appcompat/widget/f;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
...
.method private buildDropDown()I
    ...
    .line 1138
    iget-object v0, p0, Landroidx/appcompat/widget/ListPopupWindow;->mDropDownList:Landroidx/appcompat/widget/k;
    ...
    invoke-virtual {p0, v0, v5}, Landroidx/appcompat/widget/ListPopupWindow;->createDropDownListView(Landroid/content/Context;Z)Landroidx/appcompat/widget/k;

    move-result-object v5

    iput-object v5, p0, Landroidx/appcompat/widget/ListPopupWindow;->mDropDownList:Landroidx/appcompat/widget/k;
    ...
    .line 1162
    :cond_0
    iget-object v5, p0, Landroidx/appcompat/widget/ListPopupWindow;->mDropDownList:Landroidx/appcompat/widget/k;

    iget-object v6, p0, Landroidx/appcompat/widget/ListPopupWindow;->mAdapter:Landroid/widget/ListAdapter;

    invoke-virtual {v5, v6}, Landroidx/appcompat/widget/k;->setAdapter(Landroid/widget/ListAdapter;)V
    ...
    invoke-virtual {v5, v6}, Landroidx/appcompat/widget/k;->setOnItemClickListener(Landroid/widget/AdapterView$OnItemClickListener;)V

    .line 1164
    iget-object v5, p0, Landroidx/appcompat/widget/ListPopupWindow;->mDropDownList:Landroidx/appcompat/widget/k;

    invoke-virtual {v5, v3}, Landroidx/appcompat/widget/k;->setFocusable(Z)V

    .line 1165
    iget-object v5, p0, Landroidx/appcompat/widget/ListPopupWindow;->mDropDownList:Landroidx/appcompat/widget/k;

    invoke-virtual {v5, v3}, Landroidx/appcompat/widget/k;->setFocusableInTouchMode(Z)V
    ...
    invoke-virtual {v5, v6}, Landroidx/appcompat/widget/k;->setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V

    .line 1184
    iget-object v5, p0, Landroidx/appcompat/widget/ListPopupWindow;->mDropDownList:Landroidx/appcompat/widget/k;

    iget-object v6, p0, Landroidx/appcompat/widget/ListPopupWindow;->mScrollListener:Landroidx/appcompat/widget/ListPopupWindow$c;

    invoke-virtual {v5, v6}, Landroidx/appcompat/widget/k;->setOnScrollListener(Landroid/widget/AbsListView$OnScrollListener;)V
    ...
    .line 1187
    iget-object v6, p0, Landroidx/appcompat/widget/ListPopupWindow;->mDropDownList:Landroidx/appcompat/widget/k;

    invoke-virtual {v6, v5}, Landroidx/appcompat/widget/k;->setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V
    ...
    invoke-virtual/range {v6 .. v11}, Landroidx/appcompat/widget/k;->measureHeightOfChildrenCompat(IIIII)I
    ...
    .line 1304
    iget-object v2, p0, Landroidx/appcompat/widget/ListPopupWindow;->mDropDownList:Landroidx/appcompat/widget/k;

    invoke-virtual {v2}, Landroidx/appcompat/widget/k;->getPaddingTop()I

    move-result v2

    iget-object v3, p0, Landroidx/appcompat/widget/ListPopupWindow;->mDropDownList:Landroidx/appcompat/widget/k;

    .line 1305
    invoke-virtual {v3}, Landroidx/appcompat/widget/k;->getPaddingBottom()I
...
.method public clearListSelection()V
    ...
    .line 831
    invoke-virtual {v0}, Landroidx/appcompat/widget/k;->requestLayout()V
...
.method createDropDownListView(Landroid/content/Context;Z)Landroidx/appcompat/widget/k;
    .locals 1
...
.method public dismiss()V
    ...
    .line 755
    iput-object v1, p0, Landroidx/appcompat/widget/ListPopupWindow;->mDropDownList:Landroidx/appcompat/widget/k;

    .line 756
    iget-object v0, p0, Landroidx/appcompat/widget/ListPopupWindow;->mHandler:Landroid/os/Handler;

    iget-object v1, p0, Landroidx/appcompat/widget/ListPopupWindow;->mResizePopupRunnable:Landroidx/appcompat/widget/ListPopupWindow$e;
...
.method public getSelectedItem()Ljava/lang/Object;
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/k;->getSelectedItem()Ljava/lang/Object;
...
.method public getSelectedItemId()J
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/k;->getSelectedItemId()J
...
.method public getSelectedItemPosition()I
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/k;->getSelectedItemPosition()I
...
.method public getSelectedView()Landroid/view/View;
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/k;->getSelectedView()Landroid/view/View;
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    .line 979
    invoke-virtual {v6, v1, v3}, Landroidx/appcompat/widget/k;->lookForSelectablePosition(IZ)I
    ...
    invoke-virtual {v5, v4, v1}, Landroidx/appcompat/widget/k;->lookForSelectablePosition(IZ)I
    ...
    .line 995
    :cond_6
    iget-object v8, p0, Landroidx/appcompat/widget/ListPopupWindow;->mDropDownList:Landroidx/appcompat/widget/k;

    invoke-virtual {v8, v1}, Landroidx/appcompat/widget/k;->setListSelectionHidden(Z)V

    .line 998
    iget-object v8, p0, Landroidx/appcompat/widget/ListPopupWindow;->mDropDownList:Landroidx/appcompat/widget/k;

    invoke-virtual {v8, p1, p2}, Landroidx/appcompat/widget/k;->onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    .line 1009
    iget-object p2, p0, Landroidx/appcompat/widget/ListPopupWindow;->mDropDownList:Landroidx/appcompat/widget/k;

    invoke-virtual {p2}, Landroidx/appcompat/widget/k;->requestFocusFromTouch()Z
...
.method public onKeyUp(ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v0, p1, p2}, Landroidx/appcompat/widget/k;->onKeyUp(ILandroid/view/KeyEvent;)Z
...
.method public performItemClick(I)Z
    ...
    .line 862
    invoke-virtual {v2}, Landroidx/appcompat/widget/k;->getFirstVisiblePosition()I

    move-result v0

    sub-int v0, p1, v0

    invoke-virtual {v2, v0}, Landroidx/appcompat/widget/k;->getChildAt(I)Landroid/view/View;

    move-result-object v3

    .line 863
    invoke-virtual {v2}, Landroidx/appcompat/widget/k;->getAdapter()Landroid/widget/ListAdapter;
...
.method public setAdapter(Landroid/widget/ListAdapter;)V
    ...
    .line 291
    :cond_2
    iget-object p1, p0, Landroidx/appcompat/widget/ListPopupWindow;->mDropDownList:Landroidx/appcompat/widget/k;
...
.method public setSelection(I)V
    ...
    .line 813
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/k;->setSelection(I)V

    .line 815
    invoke-virtual {v0}, Landroidx/appcompat/widget/k;->getChoiceMode()I
    ...
    .line 816
    invoke-virtual {v0, p1, v1}, Landroidx/appcompat/widget/k;->setItemChecked(IZ)V
...
.method public show()V
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/ListPopupWindow;->mTouchInterceptor:Landroidx/appcompat/widget/ListPopupWindow$d;
    ...
    invoke-virtual {v0, v6}, Landroidx/appcompat/widget/k;->setSelection(I)V
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/ListPopupWindow;->mHideSelector:Landroidx/appcompat/widget/ListPopupWindow$a;
