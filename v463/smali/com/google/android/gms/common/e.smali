...
.method static a(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    invoke-static {p1, p3}, Lcom/google/android/gms/common/o;->a(Landroid/app/Dialog;Landroid/content/DialogInterface$OnCancelListener;)Lcom/google/android/gms/common/o;

    move-result-object p1

    invoke-virtual {p1, p0, p2}, Lcom/google/android/gms/common/o;->a(Landroidx/fragment/app/g;Ljava/lang/String;)V
...
.method private final a(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    invoke-static {v4}, Lcom/google/android/gms/common/internal/aa;->a(Z)V
    ...
    :cond_5
    new-instance v4, Landroidx/core/app/i$c;

    invoke-direct {v4, p1}, Landroidx/core/app/i$c;-><init>(Landroid/content/Context;)V

    const v7, 0x108008a

    invoke-virtual {v4, v7}, Landroidx/core/app/i$c;->a(I)Landroidx/core/app/i$c;
    ...
    invoke-virtual {v4, v2}, Landroidx/core/app/i$c;->c(Ljava/lang/CharSequence;)Landroidx/core/app/i$c;
    ...
    invoke-virtual {v2, v7, v8}, Landroidx/core/app/i$c;->a(J)Landroidx/core/app/i$c;

    move-result-object v2

    invoke-virtual {v2, v6}, Landroidx/core/app/i$c;->a(Z)Landroidx/core/app/i$c;

    move-result-object v2

    invoke-virtual {v2, p4}, Landroidx/core/app/i$c;->a(Landroid/app/PendingIntent;)Landroidx/core/app/i$c;

    move-result-object p4

    invoke-virtual {p4, v0}, Landroidx/core/app/i$c;->a(Ljava/lang/CharSequence;)Landroidx/core/app/i$c;

    move-result-object p4

    invoke-virtual {p4, v1}, Landroidx/core/app/i$c;->b(Ljava/lang/CharSequence;)Landroidx/core/app/i$c;

    move-result-object p4

    invoke-virtual {p4, v6}, Landroidx/core/app/i$c;->b(Z)Landroidx/core/app/i$c;
    ...
    invoke-virtual {v0, v1}, Landroidx/core/app/i$b;->a(Ljava/lang/CharSequence;)Landroidx/core/app/i$b;

    move-result-object v0

    invoke-virtual {p4, v0}, Landroidx/core/app/i$c;->a(Landroidx/core/app/i$d;)Landroidx/core/app/i$c;
    ...
    invoke-virtual {p4, p1}, Landroidx/core/app/i$c;->a(Ljava/lang/String;)Landroidx/core/app/i$c;

    :cond_6
    invoke-virtual {p4}, Landroidx/core/app/i$c;->b()Landroid/app/Notification;
    ...
    sget-object p4, Lcom/google/android/gms/common/l;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public a(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p1, p2, p3, p4}, Lcom/google/android/gms/common/e;->a(Landroid/content/Context;ILcom/google/android/gms/common/internal/h;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
...
.method public a(Landroid/content/Context;Lcom/google/android/gms/common/ConnectionResult;)Landroid/app/PendingIntent;
    ...
    invoke-virtual {p0, p1, p2, v0}, Lcom/google/android/gms/common/f;->a(Landroid/content/Context;II)Landroid/app/PendingIntent;
...
.method public a(Landroid/content/Context;Lcom/google/android/gms/common/api/internal/e$a;)Lcom/google/android/gms/common/api/internal/e;
    .locals 2
    ...
    invoke-direct {v1, p2}, Lcom/google/android/gms/common/api/internal/e;-><init>(Lcom/google/android/gms/common/api/internal/e$a;)V

    invoke-virtual {p1, v1, v0}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;

    invoke-virtual {v1, p1}, Lcom/google/android/gms/common/api/internal/e;->a(Landroid/content/Context;)V
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/common/api/internal/e$a;->a()V
...
.method public a(Landroid/app/Activity;Lcom/google/android/gms/common/api/internal/h;IILandroid/content/DialogInterface$OnCancelListener;)Z
    .locals 1
    ...
    invoke-static {p2, v0, p4}, Lcom/google/android/gms/common/internal/h;->a(Lcom/google/android/gms/common/api/internal/h;Landroid/content/Intent;I)Lcom/google/android/gms/common/internal/h;

    move-result-object p2

    invoke-static {p1, p3, p2, p5}, Lcom/google/android/gms/common/e;->a(Landroid/content/Context;ILcom/google/android/gms/common/internal/h;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
...
.method public c(Landroid/content/Context;I)Z
    ...
    invoke-super {p0, p1, p2}, Lcom/google/android/gms/common/f;->c(Landroid/content/Context;I)Z
