...
.method final c(Landroid/os/Bundle;)Z
    ...
    .line 64
    invoke-direct {v0, v10}, Lcom/google/firebase/messaging/e;->a(I)Z
    ...
    .line 92
    invoke-static {v1, v11}, Lcom/google/firebase/messaging/e;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 101
    iget-object v14, v0, Lcom/google/firebase/messaging/e;->b:Landroid/content/Context;
    ...
    .line 122
    sget-object v14, Lcom/google/firebase/messaging/e;->a:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    .line 139
    invoke-static {v12, v13, v3, v11}, Lcom/google/firebase/iid/x;->a(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    .line 147
    invoke-static {v13, v14, v3, v11}, Lcom/google/firebase/iid/x;->a(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    sget v14, Lcom/google/firebase/messaging/c$a;->fcm_fallback_notification_channel_label:I
    ...
    invoke-direct {v4, v15, v11, v13}, Landroid/app/NotificationChannel;-><init>(Ljava/lang/String;Ljava/lang/CharSequence;I)V
    ...
    iget-object v5, v0, Lcom/google/firebase/messaging/e;->b:Landroid/content/Context;
    ...
    invoke-virtual {v2, v6}, Landroid/app/Notification$BigTextStyle;->bigText(Ljava/lang/CharSequence;)Landroid/app/Notification$BigTextStyle;

    move-result-object v2

    invoke-virtual {v4, v2}, Landroid/app/Notification$Builder;->setStyle(Landroid/app/Notification$Style;)Landroid/app/Notification$Builder;
    ...
    .line 188
    invoke-virtual {v4, v15}, Landroid/app/Notification$Builder;->setChannelId(Ljava/lang/String;)Landroid/app/Notification$Builder;
    ...
    invoke-direct {v4, v5}, Landroidx/core/app/i$c;-><init>(Landroid/content/Context;)V

    const/4 v5, 0x1

    .line 193
    invoke-virtual {v4, v5}, Landroidx/core/app/i$c;->a(Z)Landroidx/core/app/i$c;

    move-result-object v4

    invoke-virtual {v4, v10}, Landroidx/core/app/i$c;->a(I)Landroidx/core/app/i$c;
    ...
    .line 195
    invoke-virtual {v4, v2}, Landroidx/core/app/i$c;->a(Ljava/lang/CharSequence;)Landroidx/core/app/i$c;
    ...
    .line 197
    invoke-virtual {v4, v6}, Landroidx/core/app/i$c;->b(Ljava/lang/CharSequence;)Landroidx/core/app/i$c;
    ...
    invoke-virtual {v2, v6}, Landroidx/core/app/i$b;->a(Ljava/lang/CharSequence;)Landroidx/core/app/i$b;

    move-result-object v2

    invoke-virtual {v4, v2}, Landroidx/core/app/i$c;->a(Landroidx/core/app/i$d;)Landroidx/core/app/i$c;
    ...
    invoke-virtual {v4, v2}, Landroidx/core/app/i$c;->e(I)Landroidx/core/app/i$c;

    :cond_28
    if-eqz v8, :cond_29

    .line 202
    invoke-virtual {v4, v8}, Landroidx/core/app/i$c;->a(Landroid/net/Uri;)Landroidx/core/app/i$c;

    :cond_29
    if-eqz v12, :cond_2a

    .line 204
    invoke-virtual {v4, v12}, Landroidx/core/app/i$c;->a(Landroid/app/PendingIntent;)Landroidx/core/app/i$c;

    :cond_2a
    if-eqz v3, :cond_2b

    .line 206
    invoke-virtual {v4, v3}, Landroidx/core/app/i$c;->b(Landroid/app/PendingIntent;)Landroidx/core/app/i$c;

    .line 207
    :cond_2b
    invoke-virtual {v4}, Landroidx/core/app/i$c;->b()Landroid/app/Notification;
