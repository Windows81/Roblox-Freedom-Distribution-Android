...
public interface c {
    ...
    void a(e.InterfaceC0166e interfaceC0166e);

    void a(h hVar, e.a aVar);

    void a(boolean z);

    void a(boolean z, List<String> list, e.InterfaceC0166e interfaceC0166e);

    boolean a(int i, int i2, Intent intent);

    void b(Activity activity, String str, int i, e.c cVar, String str2);
}
