...
public class e extends a<com.roblox.client.pushnotification.b.c> {
    ...
    @Override // com.roblox.client.pushnotification.a
    protected long e() {
        return ((com.roblox.client.pushnotification.b.c) this.f6783a.get(0)).a();
    }
    ...
    protected String b(Context context) {
        String strD = ((com.roblox.client.pushnotification.b.c) this.f6783a.get(this.f6783a.size() - 1)).d();
        String strD2 = this.f6783a.size() > 1 ? ((com.roblox.client.pushnotification.b.c) this.f6783a.get(this.f6783a.size() - 2)).d() : "";
        if (this.f6783a.size() == 1) {
            return String.format(context.getResources().getString(o.j.Notifications_PushNotifications_Label_SingleFriendAcceptedRequest), strD);
        }
        if (this.f6783a.size() == 2) {
            return String.format(context.getResources().getString(o.j.Notifications_PushNotifications_Label_TwoFriendsAcceptedRequests), strD, strD2);
        }
        if (this.f6783a.size() == 3) {
            return String.format(context.getResources().getString(o.j.Notifications_PushNotifications_Label_ThreeFriendsAcceptedRequests), strD, strD2);
        }
        if (this.f6783a.size() > 3) {
            return String.format(context.getResources().getString(o.j.Notifications_PushNotifications_Label_MoreThanThreeFriendsAcceptedRequests), strD, strD2);
        }
        return null;
    }
