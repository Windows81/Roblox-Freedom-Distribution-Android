...
public class k extends a<com.roblox.client.pushnotification.b.f> {
    ...
    @Override // com.roblox.client.pushnotification.a
    public long e() {
        return ((com.roblox.client.pushnotification.b.f) this.f6783a.get(this.f6783a.size() - 1)).e();
    }

    @Override // com.roblox.client.pushnotification.a
    protected String b(Context context) {
        return this.f6783a.size() == 1 ? String.format(context.getResources().getString(o.j.Notifications_PushNotifications_Label_SentPrivateMessage), c().d()) : String.format(context.getResources().getString(o.j.Notifications_PushNotifications_Label_NewPrivateMessages), String.valueOf(this.f6783a.size()));
    }
