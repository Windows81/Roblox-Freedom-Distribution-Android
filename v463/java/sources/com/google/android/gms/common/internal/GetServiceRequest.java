...
public class GetServiceRequest extends AbstractSafeParcelable {
    ...
    public GetServiceRequest(int i) {
        this.f3717a = 4;
        this.f3719c = com.google.android.gms.common.f.f3704b;
        this.f3718b = i;
        this.k = true;
    }
    ...
    GetServiceRequest(int i, int i2, int i3, String str, IBinder iBinder, Scope[] scopeArr, Bundle bundle, Account account, Feature[] featureArr, Feature[] featureArr2, boolean z) {
        ...
        if ("com.google.android.gms".equals(str)) {
            this.f3720d = "com.google.android.gms";
        } else {
            this.f3720d = str;
        }
        if (i < 2) {
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        com.google.android.gms.common.internal.safeparcel.b.a(parcel, 1, this.f3717a);
        com.google.android.gms.common.internal.safeparcel.b.a(parcel, 2, this.f3718b);
        com.google.android.gms.common.internal.safeparcel.b.a(parcel, 3, this.f3719c);
        com.google.android.gms.common.internal.safeparcel.b.a(parcel, 4, this.f3720d, false);
        com.google.android.gms.common.internal.safeparcel.b.a(parcel, 5, this.f3721e, false);
