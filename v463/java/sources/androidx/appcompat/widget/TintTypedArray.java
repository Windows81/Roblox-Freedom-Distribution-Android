...
public class TintTypedArray {
    ...
    public Drawable getDrawable(int i) {
        ...
        if (this.mWrapped.hasValue(i) && (resourceId = this.mWrapped.getResourceId(i, 0)) != 0) {
            return androidx.appcompat.a.a.a.b(this.mContext, resourceId);
        }
    ...
    public Typeface getFont(int i, int i2, f.a aVar) {
        ...
        return androidx.core.a.a.f.a(this.mContext, resourceId, this.mTypedValue, i2, aVar);
    }
    ...
    public ColorStateList getColorStateList(int i) {
        ...
        return (!this.mWrapped.hasValue(i) || (resourceId = this.mWrapped.getResourceId(i, 0)) == 0 || (colorStateListA = androidx.appcompat.a.a.a.a(this.mContext, resourceId)) == null) ? this.mWrapped.getColorStateList(i) : colorStateListA;
    }
