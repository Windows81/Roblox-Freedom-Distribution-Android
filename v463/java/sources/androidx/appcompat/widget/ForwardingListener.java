...
public abstract class ForwardingListener implements View.OnAttachStateChangeListener, View.OnTouchListener {
    ...
    public abstract androidx.appcompat.view.menu.s getPopup();
    ...
    protected boolean onForwardingStarted() {
        androidx.appcompat.view.menu.s popup = getPopup();
    ...
    */
    ...
    private boolean onTouchForwarded(MotionEvent motionEvent) {
        ...
        toLocalMotionEvent(kVar, motionEventObtainNoHistory);
        boolean zOnForwardedEvent = kVar.onForwardedEvent(motionEventObtainNoHistory, this.mActivePointerId);
