...
public final class ViewStubCompat extends View {
    ...
    public ViewStubCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mInflatedId = typedArrayObtainStyledAttributes.getResourceId(a.j.ViewStubCompat_android_inflatedId, -1);
        this.mLayoutResource = typedArrayObtainStyledAttributes.getResourceId(a.j.ViewStubCompat_android_layout, 0);
