...
public class ActionMenuView extends LinearLayoutCompat implements h.b, androidx.appcompat.view.menu.p {
    ...
    private androidx.appcompat.widget.b mPresenter;
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        androidx.appcompat.widget.b bVar = this.mPresenter;
        if (bVar != null) {
            bVar.a(false);
    ...
    private void onMeasureExactFormat(int i, int i2) {
        ...
        while (i12 < childCount) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                layoutParams.preventEdgeOffset = z5 && ((ActionMenuItemView) childAt).b();
    ...
    public Menu getMenu() {
        if (this.mMenu == null) {
            ...
            this.mPresenter = bVar;
            bVar.b(true);
            androidx.appcompat.widget.b bVar2 = this.mPresenter;
            o.a aVar = this.mActionMenuPresenterCallback;
            if (aVar == null) {
                aVar = new a();
            }
            bVar2.a(aVar);
