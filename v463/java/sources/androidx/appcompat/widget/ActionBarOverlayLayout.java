...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, androidx.core.h.l {
    ...
    private final androidx.core.h.n mParentHelper;
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attributeSet) {
        ...
        init(context);
        this.mParentHelper = new androidx.core.h.n(this);
    }
    ...
    protected boolean fitSystemWindows(Rect rect) {
        pullChildren();
        int iN = androidx.core.h.r.n(this) & 256;
    ...
    protected void onMeasure(int i, int i2) {
        ...
        boolean z = (androidx.core.h.r.n(this) & 256) != 0;
        if (z) {
