...
class j {
    ...
    private static final RectF f1003a = new RectF();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static ConcurrentHashMap<String, Method> f1004b = new ConcurrentHashMap<>();

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private int f1005c = 0;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private boolean f1006d = false;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private float f1007e = -1.0f;
    ...
    void a(AttributeSet attributeSet, int i) {
        ...
        if (typedArrayObtainStyledAttributes.hasValue(a.j.AppCompatTextView_autoSizeTextType)) {
            this.f1005c = typedArrayObtainStyledAttributes.getInt(a.j.AppCompatTextView_autoSizeTextType, 0);
        }
    ...
    private boolean i() {
        if (k() && this.f1005c == 1) {
            if (!this.i || this.h.length == 0) {
                ...
                int i = 1;
                while (Math.round(this.f1007e + fRound) <= Math.round(this.g)) {
                    i++;
                    fRound += this.f1007e;
                }
                int[] iArr = new int[i];
    ...
    void f() {
        if (g()) {
            if (this.f1006d) {
                ...
                synchronized (f1003a) {
                    f1003a.setEmpty();
                    f1003a.right = measuredWidth;
                    f1003a.bottom = height;
                    float fA = a(f1003a);
    ...
    private Method a(String str) {
        try {
            Method declaredMethod = f1004b.get(str);
            if (declaredMethod == null && (declaredMethod = TextView.class.getDeclaredMethod(str, new Class[0])) != null) {
                declaredMethod.setAccessible(true);
                f1004b.put(str, declaredMethod);
            }
