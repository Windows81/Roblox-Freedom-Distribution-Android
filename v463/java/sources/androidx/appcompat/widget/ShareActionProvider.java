...
public class ShareActionProvider extends androidx.core.h.b {
    ...
    public View onCreateActionView() {
        ...
        this.mContext.getTheme().resolveAttribute(a.C0012a.actionModeShareDrawable, typedValue, true);
        activityChooserView.setExpandActivityOverflowButtonDrawable(androidx.appcompat.a.a.a.b(this.mContext, typedValue.resourceId));
