...
public class Toolbar extends ViewGroup {
    ...
    public void setMenu(androidx.appcompat.view.menu.h hVar, b bVar) {
        ...
        bVar.c(true);
        if (hVar != null) {
            hVar.a(bVar, this.mPopupContext);
            hVar.a(this.mExpandedMenuPresenter, this.mPopupContext);
        } else {
            bVar.a(this.mPopupContext, (androidx.appcompat.view.menu.h) null);
            this.mExpandedMenuPresenter.a(this.mPopupContext, (androidx.appcompat.view.menu.h) null);
            bVar.a(true);
    ...
    public boolean hasExpandedActionView() {
        ...
        return (aVar == null || aVar.f958b == null) ? false : true;
    }

    public void collapseActionView() {
        a aVar = this.mExpandedMenuPresenter;
        androidx.appcompat.view.menu.j jVar = aVar == null ? null : aVar.f958b;
        if (jVar != null) {
    ...
    public int getCurrentContentInsetEnd() {
        ...
        ActionMenuView actionMenuView = this.mMenuView;
        if ((actionMenuView == null || (hVarPeekMenu = actionMenuView.peekMenu()) == null || !hVarPeekMenu.hasVisibleItems()) ? false : true) {
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            this.mNavButtonView = new AppCompatImageButton(getContext(), null, a.C0012a.toolbarNavigationButtonStyle);
            LayoutParams layoutParamsGenerateDefaultLayoutParams = generateDefaultLayoutParams();
    ...
    void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            AppCompatImageButton appCompatImageButton = new AppCompatImageButton(getContext(), null, a.C0012a.toolbarNavigationButtonStyle);
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        if (aVar != null && aVar.f958b != null) {
            savedState.expandedMenuItemId = this.mExpandedMenuPresenter.f958b.getItemId();
        }
    ...
    */
    ...
    private void addCustomViewsWithGravity(List<View> list, int i) {
        boolean z = androidx.core.h.r.f(this) == 1;
        int childCount = getChildCount();
        int iA = androidx.core.h.c.a(i, androidx.core.h.r.f(this));
        list.clear();
        if (!z) {
    ...
    private int getChildHorizontalGravity(int i) {
        int iF = androidx.core.h.r.f(this);
        int iA = androidx.core.h.c.a(i, iF) & 7;
    ...
    private class a implements androidx.appcompat.view.menu.o {
        ...
        androidx.appcompat.view.menu.h f957a;

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        androidx.appcompat.view.menu.j f958b;
        ...
        public void a(Context context, androidx.appcompat.view.menu.h hVar) {
            ...
            androidx.appcompat.view.menu.h hVar2 = this.f957a;
            if (hVar2 != null && (jVar = this.f958b) != null) {
                hVar2.d(jVar);
            }
            this.f957a = hVar;
        }
        ...
        public void a(boolean z) {
            if (this.f958b != null) {
                androidx.appcompat.view.menu.h hVar = this.f957a;
                boolean z2 = false;
                if (hVar != null) {
                    int size = hVar.size();
                    int i = 0;
                    while (true) {
                        ...
                        if (this.f957a.getItem(i) == this.f958b) {
                            z2 = true;
                            break;
                        }
                        i++;
