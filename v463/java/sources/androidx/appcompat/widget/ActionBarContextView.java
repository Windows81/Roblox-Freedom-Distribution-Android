...
public class ActionBarContextView extends AbsActionBarView {
    ...
    @Override // androidx.appcompat.widget.AbsActionBarView
    public /* bridge */ /* synthetic */ v setupAnimatorToVisibility(int i, long j) {
    ...
    public ActionBarContextView(Context context, AttributeSet attributeSet, int i) {
        ...
        androidx.core.h.r.a(this, tintTypedArrayObtainStyledAttributes.getDrawable(a.j.ActionMode_background));
    ...
    private void initTitle() {
        if (this.mTitleLayout == null) {
            ...
            this.mTitleView = (TextView) linearLayout.findViewById(a.f.action_bar_title);
    ...
    public void initForMode(final androidx.appcompat.view.b bVar) {
        ...
        this.mClose.findViewById(a.f.action_mode_close_button).setOnClickListener(new View.OnClickListener() { // from class: androidx.appcompat.widget.ActionBarContextView.1
        ...
        androidx.core.h.r.a(this.mMenuView, (Drawable) null);
