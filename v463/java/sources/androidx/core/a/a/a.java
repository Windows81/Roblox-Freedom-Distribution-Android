        ...
        while (true) {
            ...
            if (next == 2 && depth <= depth2 && xmlPullParser.getName().equals("item")) {
                ...
                if (typedArrayA.hasValue(a.d.ColorStateListItem_android_alpha)) {
                    f = typedArrayA.getFloat(a.d.ColorStateListItem_android_alpha, 1.0f);
                } else if (typedArrayA.hasValue(a.d.ColorStateListItem_alpha)) {
                    f = typedArrayA.getFloat(a.d.ColorStateListItem_alpha, 1.0f);
                }
                typedArrayA.recycle();
                ...
                for (int i4 = 0; i4 < attributeCount; i4++) {
                    ...
                    if (attributeNameResource != 16843173 && attributeNameResource != 16843551 && attributeNameResource != a.C0023a.alpha) {
                        int i5 = i3 + 1;
                ...
                iArrA = e.a(iArrA, i2, iA);
                iArr = (int[][]) e.a(iArr, i2, iArrTrimStateSet);
                i2++;
            }
            i = 1;
        }
