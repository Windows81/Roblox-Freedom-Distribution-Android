...
class r {
    ...
    private static final boolean f2027a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final boolean f2028b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final boolean f2029c;

    static {
        f2027a = Build.VERSION.SDK_INT >= 19;
        f2028b = Build.VERSION.SDK_INT >= 18;
        f2029c = Build.VERSION.SDK_INT >= 28;
    }
    ...
    */
    private static android.graphics.Bitmap a(android.view.View r8, android.graphics.Matrix r9, android.graphics.RectF r10, android.view.ViewGroup r11) {
        /*
            boolean r0 = androidx.k.r.f2027a
            r1 = 0
            if (r0 == 0) goto L13
        ...
        L14:
            r2 = 0
        L15:
            boolean r3 = androidx.k.r.f2028b
            r4 = 0
            if (r3 == 0) goto L31
            if (r0 == 0) goto L31
            if (r2 != 0) goto L1f
        ...
        L33:
            ...
            r9.postScale(r4, r4)
            boolean r10 = androidx.k.r.f2029c
            if (r10 == 0) goto L88
        ...
        L88:
            ...
            r8.draw(r10)
        L99:
            boolean r9 = androidx.k.r.f2028b
            if (r9 == 0) goto La9
            if (r0 == 0) goto La9
        ...
        La9:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.k.r.a(android.view.View, android.graphics.Matrix, android.graphics.RectF, android.view.ViewGroup):android.graphics.Bitmap");
    }
