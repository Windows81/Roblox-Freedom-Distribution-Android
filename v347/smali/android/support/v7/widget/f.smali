...
.method constructor <init>(Landroid/widget/CompoundButton;)V
    ...
    .line 36
    iput-object v1, p0, Landroid/support/v7/widget/f;->b:Landroid/content/res/ColorStateList;

    .line 37
    iput-object v1, p0, Landroid/support/v7/widget/f;->c:Landroid/graphics/PorterDuff$Mode;

    .line 38
    iput-boolean v0, p0, Landroid/support/v7/widget/f;->d:Z

    .line 39
    iput-boolean v0, p0, Landroid/support/v7/widget/f;->e:Z

    .line 51
    iput-object p1, p0, Landroid/support/v7/widget/f;->a:Landroid/widget/CompoundButton;
...
.method a(I)I
    ...
    .line 138
    iget-object v0, p0, Landroid/support/v7/widget/f;->a:Landroid/widget/CompoundButton;
...
.method a()Landroid/content/res/ColorStateList;
    ...
    .prologue
    .line 89
    iget-object v0, p0, Landroid/support/v7/widget/f;->b:Landroid/content/res/ColorStateList;
...
.method a(Landroid/content/res/ColorStateList;)V
    ...
    .prologue
    .line 82
    iput-object p1, p0, Landroid/support/v7/widget/f;->b:Landroid/content/res/ColorStateList;
...
.method a(Landroid/graphics/PorterDuff$Mode;)V
    ...
    .prologue
    .line 93
    iput-object p1, p0, Landroid/support/v7/widget/f;->c:Landroid/graphics/PorterDuff$Mode;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    .line 62
    iget-object v2, p0, Landroid/support/v7/widget/f;->a:Landroid/widget/CompoundButton;

    iget-object v3, p0, Landroid/support/v7/widget/f;->a:Landroid/widget/CompoundButton;
...
.method b()Landroid/graphics/PorterDuff$Mode;
    ...
    .prologue
    .line 100
    iget-object v0, p0, Landroid/support/v7/widget/f;->c:Landroid/graphics/PorterDuff$Mode;
...
.method c()V
    ...
    iput-boolean v0, p0, Landroid/support/v7/widget/f;->f:Z
...
.method d()V
    ...
    iget-boolean v1, p0, Landroid/support/v7/widget/f;->d:Z

    if-nez v1, :cond_0

    iget-boolean v1, p0, Landroid/support/v7/widget/f;->e:Z
    ...
    .line 120
    iget-object v1, p0, Landroid/support/v7/widget/f;->b:Landroid/content/res/ColorStateList;
    ...
    .line 123
    iget-object v1, p0, Landroid/support/v7/widget/f;->c:Landroid/graphics/PorterDuff$Mode;
    ...
    .line 128
    iget-object v1, p0, Landroid/support/v7/widget/f;->a:Landroid/widget/CompoundButton;
