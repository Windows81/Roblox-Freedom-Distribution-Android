...
.method constructor <init>(Landroid/support/v7/widget/RecyclerView;)V
    ...
    .line 4821
    iput-object p1, p0, Landroid/support/v7/widget/RecyclerView$d;->b:Landroid/support/v7/widget/RecyclerView;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView$d;->a:Landroid/view/animation/Interpolator;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView$d;->e:Landroid/widget/OverScroller;
...
.method static synthetic a(Landroid/support/v7/widget/RecyclerView$d;)Landroid/widget/OverScroller;
    .locals 1

    .prologue
    .line 4808
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView$d;->e:Landroid/widget/OverScroller;
...
.method private b(IIII)I
    ...
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView$d;->b:Landroid/support/v7/widget/RecyclerView;
...
.method a()V
    ...
    .line 4974
    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView$d;->b:Landroid/support/v7/widget/RecyclerView;
...
.method public a(II)V
    ...
    .line 4981
    iput v1, p0, Landroid/support/v7/widget/RecyclerView$d;->d:I
...
.method public a(IIILandroid/view/animation/Interpolator;)V
    ...
    .line 5033
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView$d;->a:Landroid/view/animation/Interpolator;

    if-eq v0, p4, :cond_0

    .line 5034
    iput-object p4, p0, Landroid/support/v7/widget/RecyclerView$d;->a:Landroid/view/animation/Interpolator;

    .line 5035
    new-instance v0, Landroid/widget/OverScroller;

    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView$d;->b:Landroid/support/v7/widget/RecyclerView;
...
.method public run()V
    ...
    iget-object v2, v0, Landroid/support/v7/widget/RecyclerView$d;->b:Landroid/support/v7/widget/RecyclerView;
    ...
    iget-object v14, v0, Landroid/support/v7/widget/RecyclerView$d;->e:Landroid/widget/OverScroller;
    ...
    iget v2, v0, Landroid/support/v7/widget/RecyclerView$d;->c:I
    ...
    iget v2, v0, Landroid/support/v7/widget/RecyclerView$d;->d:I
    ...
    iput v0, v1, Landroid/support/v7/widget/RecyclerView$d;->c:I
    ...
    iput v0, v1, Landroid/support/v7/widget/RecyclerView$d;->d:I
    ...
    iget-object v3, v0, Landroid/support/v7/widget/RecyclerView$d;->b:Landroid/support/v7/widget/RecyclerView;
    ...
    iget-object v4, v0, Landroid/support/v7/widget/RecyclerView$d;->b:Landroid/support/v7/widget/RecyclerView;
    ...
    iget-object v6, v0, Landroid/support/v7/widget/RecyclerView$d;->b:Landroid/support/v7/widget/RecyclerView;
    ...
    iget-object v2, v2, Landroid/support/v7/widget/RecyclerView;->mPrefetchRegistry:Landroid/support/v7/widget/q$a;

    invoke-virtual {v2}, Landroid/support/v7/widget/q$a;->a()V
    ...
    iget-boolean v2, v0, Landroid/support/v7/widget/RecyclerView$d;->g:Z
    ...
    iget-object v2, v2, Landroid/support/v7/widget/RecyclerView;->mGapWorker:Landroid/support/v7/widget/q;
    ...
    invoke-virtual {v2, v3, v10, v9}, Landroid/support/v7/widget/q;->a(Landroid/support/v7/widget/RecyclerView;II)V
