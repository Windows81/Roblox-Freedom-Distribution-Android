...
.field private static final COLOR_FILTER_CACHE:Landroid/support/v7/widget/AppCompatDrawableManager$b;
...
# instance fields
.field private mDelegates:Landroid/support/v4/g/a;
...
.field private mKnownDrawableIdTags:Landroid/support/v4/g/n;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v7}, Landroid/support/v7/widget/AppCompatDrawableManager$b;-><init>(I)V

    sput-object v0, Landroid/support/v7/widget/AppCompatDrawableManager;->COLOR_FILTER_CACHE:Landroid/support/v7/widget/AppCompatDrawableManager$b;
...
.method private addDelegate(Ljava/lang/String;Landroid/support/v7/widget/AppCompatDrawableManager$c;)V
    .locals 1

    .prologue
    .line 490
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatDrawableManager;->mDelegates:Landroid/support/v4/g/a;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/AppCompatDrawableManager;->mDelegates:Landroid/support/v4/g/a;
...
.method private createButtonColorStateList(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v3}, Landroid/support/v7/widget/x;->a(Landroid/content/Context;I)I
    ...
    invoke-static {p1, v4}, Landroid/support/v7/widget/x;->c(Landroid/content/Context;I)I

    move-result v4

    .line 605
    sget-object v5, Landroid/support/v7/widget/x;->a:[I
    ...
    .line 609
    sget-object v4, Landroid/support/v7/widget/x;->d:[I
    ...
    .line 613
    sget-object v4, Landroid/support/v7/widget/x;->b:[I
    ...
    .line 618
    sget-object v3, Landroid/support/v7/widget/x;->h:[I
...
.method private createColoredButtonColorStateList(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    .line 592
    invoke-static {p1, v0}, Landroid/support/v7/widget/x;->a(Landroid/content/Context;I)I
...
.method private createSwitchThumbColorStateList(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v2}, Landroid/support/v7/widget/x;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 638
    sget-object v3, Landroid/support/v7/widget/x;->a:[I
    ...
    .line 642
    sget-object v3, Landroid/support/v7/widget/x;->e:[I
    ...
    .line 654
    :cond_0
    sget-object v2, Landroid/support/v7/widget/x;->a:[I
    ...
    invoke-static {p1, v2}, Landroid/support/v7/widget/x;->c(Landroid/content/Context;I)I
    ...
    .line 658
    sget-object v2, Landroid/support/v7/widget/x;->e:[I
    ...
    invoke-static {p1, v2}, Landroid/support/v7/widget/x;->a(Landroid/content/Context;I)I
    ...
    .line 663
    sget-object v2, Landroid/support/v7/widget/x;->h:[I
...
.method public static getPorterDuffColorFilter(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    .prologue
    .line 727
    sget-object v0, Landroid/support/v7/widget/AppCompatDrawableManager;->COLOR_FILTER_CACHE:Landroid/support/v7/widget/AppCompatDrawableManager$b;
    ...
    .line 732
    sget-object v1, Landroid/support/v7/widget/AppCompatDrawableManager;->COLOR_FILTER_CACHE:Landroid/support/v7/widget/AppCompatDrawableManager$b;
...
.method private static installDefaultInflateDelegates(Landroid/support/v7/widget/AppCompatDrawableManager;)V
    ...
    invoke-direct {p0, v0, v1}, Landroid/support/v7/widget/AppCompatDrawableManager;->addDelegate(Ljava/lang/String;Landroid/support/v7/widget/AppCompatDrawableManager$c;)V
...
.method private loadDrawableFromDelegates(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 306
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatDrawableManager;->mKnownDrawableIdTags:Landroid/support/v4/g/n;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/AppCompatDrawableManager;->mDelegates:Landroid/support/v4/g/a;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/AppCompatDrawableManager;->mKnownDrawableIdTags:Landroid/support/v4/g/n;
    ...
    .line 381
    iget-object v1, p0, Landroid/support/v7/widget/AppCompatDrawableManager;->mKnownDrawableIdTags:Landroid/support/v4/g/n;
    ...
    .line 358
    iget-object v7, p0, Landroid/support/v7/widget/AppCompatDrawableManager;->mKnownDrawableIdTags:Landroid/support/v4/g/n;

    invoke-virtual {v7, p2, v0}, Landroid/support/v4/g/n;->c(ILjava/lang/Object;)V

    .line 361
    iget-object v7, p0, Landroid/support/v7/widget/AppCompatDrawableManager;->mDelegates:Landroid/support/v4/g/a;

    invoke-virtual {v7, v0}, Landroid/support/v4/g/a;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Landroid/support/v7/widget/AppCompatDrawableManager$c;
    ...
    .line 363
    invoke-interface {v0, p1, v3, v6, v7}, Landroid/support/v7/widget/AppCompatDrawableManager$c;->a(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
...
.method private removeDelegate(Ljava/lang/String;Landroid/support/v7/widget/AppCompatDrawableManager$c;)V
    .locals 1
...
.method private tintDrawable(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    .line 281
    invoke-static {p1, v1}, Landroid/support/v7/widget/x;->a(Landroid/content/Context;I)I
...
.method static tintDrawable(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/y;[I)V
    .locals 2
    ...
    .line 700
    :cond_1
    iget-boolean v0, p1, Landroid/support/v7/widget/y;->d:Z

    if-nez v0, :cond_2

    iget-boolean v0, p1, Landroid/support/v7/widget/y;->c:Z
    ...
    iget-object v0, p1, Landroid/support/v7/widget/y;->a:Landroid/content/res/ColorStateList;

    :goto_1
    iget-boolean v1, p1, Landroid/support/v7/widget/y;->c:Z

    if-eqz v1, :cond_4

    iget-object v1, p1, Landroid/support/v7/widget/y;->b:Landroid/graphics/PorterDuff$Mode;
...
.method static tintDrawableUsingColorFilter(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    .line 472
    :cond_0
    invoke-static {p0, v4}, Landroid/support/v7/widget/x;->a(Landroid/content/Context;I)I
...
.method getTintList(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v0}, Landroid/support/v7/widget/x;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
