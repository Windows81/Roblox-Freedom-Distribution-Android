...
.field private final f:Landroid/support/v7/widget/m;
...
.method constructor <init>(Landroid/widget/TextView;)V
    ...
    .line 72
    iput-object p1, p0, Landroid/support/v7/widget/k;->a:Landroid/widget/TextView;

    .line 73
    new-instance v0, Landroid/support/v7/widget/m;

    iget-object v1, p0, Landroid/support/v7/widget/k;->a:Landroid/widget/TextView;

    invoke-direct {v0, v1}, Landroid/support/v7/widget/m;-><init>(Landroid/widget/TextView;)V

    iput-object v0, p0, Landroid/support/v7/widget/k;->f:Landroid/support/v7/widget/m;

    .line 74
    return-void
.end method

.method static a(Landroid/widget/TextView;)Landroid/support/v7/widget/k;
    .locals 2
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/widget/k;-><init>(Landroid/widget/TextView;)V

    goto :goto_0
.end method

.method protected static a(Landroid/content/Context;Landroid/support/v7/widget/AppCompatDrawableManager;I)Landroid/support/v7/widget/y;
    .locals 3
...
.method private a(Landroid/content/Context;Landroid/support/v7/widget/TintTypedArray;)V
    ...
    iget v3, p0, Landroid/support/v7/widget/k;->g:I
    ...
    iput-object v0, p0, Landroid/support/v7/widget/k;->h:Landroid/graphics/Typeface;
    ...
    iget-object v4, p0, Landroid/support/v7/widget/k;->a:Landroid/widget/TextView;

    invoke-direct {v3, v4}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    .line 221
    new-instance v4, Landroid/support/v7/widget/k$1;

    invoke-direct {v4, p0, v3}, Landroid/support/v7/widget/k$1;-><init>(Landroid/support/v7/widget/k;Ljava/lang/ref/WeakReference;)V
    ...
    iput-object v3, p0, Landroid/support/v7/widget/k;->h:Landroid/graphics/Typeface;

    .line 236
    iget-object v3, p0, Landroid/support/v7/widget/k;->h:Landroid/graphics/Typeface;
    ...
    :cond_1
    :goto_2
    iget-object v1, p0, Landroid/support/v7/widget/k;->h:Landroid/graphics/Typeface;
    ...
    .line 253
    iput-boolean v2, p0, Landroid/support/v7/widget/k;->i:Z
...
.method static synthetic a(Landroid/support/v7/widget/k;Ljava/lang/ref/WeakReference;Landroid/graphics/Typeface;)V
    .locals 0

    .prologue
    .line 43
    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/k;->a(Ljava/lang/ref/WeakReference;Landroid/graphics/Typeface;)V
...
.method private a(Ljava/lang/ref/WeakReference;Landroid/graphics/Typeface;)V
    ...
    .line 273
    iput-object p2, p0, Landroid/support/v7/widget/k;->h:Landroid/graphics/Typeface;
...
.method private b(IF)V
    ...
    .prologue
    .line 373
    iget-object v0, p0, Landroid/support/v7/widget/k;->f:Landroid/support/v7/widget/m;
...
.method a()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/k;->d:Landroid/support/v7/widget/y;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/k;->e:Landroid/support/v7/widget/y;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/k;->b:Landroid/support/v7/widget/y;

    invoke-virtual {p0, v1, v2}, Landroid/support/v7/widget/k;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/y;)V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/k;->c:Landroid/support/v7/widget/y;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/k;->d:Landroid/support/v7/widget/y;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/k;->e:Landroid/support/v7/widget/y;

    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/k;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/y;)V
...
.method a(IF)V
    ...
    .line 354
    invoke-virtual {p0}, Landroid/support/v7/widget/k;->c()Z
    ...
    .line 355
    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/k;->b(IF)V
...
.method a(Landroid/content/Context;I)V
    ...
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/k;->a(Z)V
    ...
    .line 298
    iget-object v2, p0, Landroid/support/v7/widget/k;->a:Landroid/widget/TextView;

    invoke-virtual {v2, v1}, Landroid/widget/TextView;->setTextColor(Landroid/content/res/ColorStateList;)V

    .line 302
    :cond_1
    invoke-direct {p0, p1, v0}, Landroid/support/v7/widget/k;->a(Landroid/content/Context;Landroid/support/v7/widget/TintTypedArray;)V

    .line 303
    invoke-virtual {v0}, Landroid/support/v7/widget/TintTypedArray;->recycle()V

    .line 304
    iget-object v0, p0, Landroid/support/v7/widget/k;->h:Landroid/graphics/Typeface;
    ...
    iget v2, p0, Landroid/support/v7/widget/k;->g:I
...
.method final a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/y;)V
    ...
    invoke-static {p1, p2, v0}, Landroid/support/v7/widget/AppCompatDrawableManager;->tintDrawable(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/y;[I)V
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    .line 87
    invoke-static {v7, v0, v6}, Landroid/support/v7/widget/k;->a(Landroid/content/Context;Landroid/support/v7/widget/AppCompatDrawableManager;I)Landroid/support/v7/widget/y;

    move-result-object v6

    iput-object v6, p0, Landroid/support/v7/widget/k;->b:Landroid/support/v7/widget/y;
    ...
    iput-object v6, p0, Landroid/support/v7/widget/k;->c:Landroid/support/v7/widget/y;
    ...
    iput-object v6, p0, Landroid/support/v7/widget/k;->d:Landroid/support/v7/widget/y;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/k;->e:Landroid/support/v7/widget/y;
    ...
    .line 123
    :goto_0
    invoke-direct {p0, v7, v9}, Landroid/support/v7/widget/k;->a(Landroid/content/Context;Landroid/support/v7/widget/TintTypedArray;)V
    ...
    .line 178
    invoke-virtual {p0, v3}, Landroid/support/v7/widget/k;->a(Z)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/k;->f:Landroid/support/v7/widget/m;

    .line 197
    invoke-virtual {v1}, Landroid/support/v7/widget/m;->c()I

    move-result v1

    iget-object v3, p0, Landroid/support/v7/widget/k;->f:Landroid/support/v7/widget/m;

    .line 198
    invoke-virtual {v3}, Landroid/support/v7/widget/m;->d()I

    move-result v3

    iget-object v4, p0, Landroid/support/v7/widget/k;->f:Landroid/support/v7/widget/m;

    .line 199
    invoke-virtual {v4}, Landroid/support/v7/widget/m;->b()I
...
.method c()Z
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/m;->g()Z
