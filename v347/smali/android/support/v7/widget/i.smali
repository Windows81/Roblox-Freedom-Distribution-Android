...
.method constructor <init>(Landroid/widget/ProgressBar;)V
    ...
    .line 47
    iput-object p1, p0, Landroid/support/v7/widget/i;->b:Landroid/widget/ProgressBar;
...
.method private a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v3, v4}, Landroid/support/v7/widget/i;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
...
.method private a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 75
    invoke-direct {p0, v0, p2}, Landroid/support/v7/widget/i;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :goto_2
    invoke-direct {p0, v6, v0}, Landroid/support/v7/widget/i;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 99
    iget-object v1, p0, Landroid/support/v7/widget/i;->c:Landroid/graphics/Bitmap;

    if-nez v1, :cond_7

    .line 100
    iput-object v0, p0, Landroid/support/v7/widget/i;->c:Landroid/graphics/Bitmap;

    .line 103
    :cond_7
    new-instance v1, Landroid/graphics/drawable/ShapeDrawable;

    invoke-direct {p0}, Landroid/support/v7/widget/i;->b()Landroid/graphics/drawable/shapes/Shape;
...
.method a()Landroid/graphics/Bitmap;
    ...
    .prologue
    .line 144
    iget-object v0, p0, Landroid/support/v7/widget/i;->c:Landroid/graphics/Bitmap;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    .line 51
    iget-object v0, p0, Landroid/support/v7/widget/i;->b:Landroid/widget/ProgressBar;
    ...
    .line 56
    iget-object v2, p0, Landroid/support/v7/widget/i;->b:Landroid/widget/ProgressBar;

    invoke-direct {p0, v1}, Landroid/support/v7/widget/i;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v1, v3}, Landroid/support/v7/widget/i;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
