...
.method constructor <init>(Landroid/support/v7/widget/ViewBoundsCheck$b;)V
    ...
    .line 132
    new-instance v0, Landroid/support/v7/widget/ViewBoundsCheck$a;

    invoke-direct {v0}, Landroid/support/v7/widget/ViewBoundsCheck$a;-><init>()V

    iput-object v0, p0, Landroid/support/v7/widget/ViewBoundsCheck;->b:Landroid/support/v7/widget/ViewBoundsCheck$a;
...
.method a(IIII)Landroid/view/View;
    ...
    invoke-interface {v0}, Landroid/support/v7/widget/ViewBoundsCheck$b;->b()I
    ...
    invoke-interface {v1, p1}, Landroid/support/v7/widget/ViewBoundsCheck$b;->a(I)Landroid/view/View;
    ...
    invoke-interface {v5, v1}, Landroid/support/v7/widget/ViewBoundsCheck$b;->a(Landroid/view/View;)I
    ...
    invoke-interface {v6, v1}, Landroid/support/v7/widget/ViewBoundsCheck$b;->b(Landroid/view/View;)I
    ...
    invoke-virtual {v7, v3, v4, v5, v6}, Landroid/support/v7/widget/ViewBoundsCheck$a;->a(IIII)V
...
.method a(Landroid/view/View;I)Z
    ...
    .line 251
    invoke-virtual {v0, v1, v2, v3, v4}, Landroid/support/v7/widget/ViewBoundsCheck$a;->a(IIII)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ViewBoundsCheck$a;->a()V

    .line 255
    iget-object v0, p0, Landroid/support/v7/widget/ViewBoundsCheck;->b:Landroid/support/v7/widget/ViewBoundsCheck$a;

    invoke-virtual {v0, p2}, Landroid/support/v7/widget/ViewBoundsCheck$a;->a(I)V

    .line 256
    iget-object v0, p0, Landroid/support/v7/widget/ViewBoundsCheck;->b:Landroid/support/v7/widget/ViewBoundsCheck$a;

    invoke-virtual {v0}, Landroid/support/v7/widget/ViewBoundsCheck$a;->b()Z
