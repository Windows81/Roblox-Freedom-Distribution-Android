...
.method constructor <init>(Landroid/widget/SeekBar;)V
    ...
    .line 42
    invoke-direct {p0, p1}, Landroid/support/v7/widget/i;-><init>(Landroid/widget/ProgressBar;)V
    ...
    .line 43
    iput-object p1, p0, Landroid/support/v7/widget/j;->a:Landroid/widget/SeekBar;
...
.method private d()V
    ...
    .prologue
    .line 125
    iget-object v0, p0, Landroid/support/v7/widget/j;->b:Landroid/graphics/drawable/Drawable;

    if-eqz v0, :cond_3

    iget-boolean v0, p0, Landroid/support/v7/widget/j;->e:Z
    ...
    iput-object v0, p0, Landroid/support/v7/widget/j;->b:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/j;->a:Landroid/widget/SeekBar;
...
.method a(Landroid/graphics/Canvas;)V
    ...
    .line 163
    iget-object v1, p0, Landroid/support/v7/widget/j;->b:Landroid/graphics/drawable/Drawable;
    ...
    .line 167
    iget-object v3, p0, Landroid/support/v7/widget/j;->b:Landroid/graphics/drawable/Drawable;
    ...
    .line 172
    iget-object v0, p0, Landroid/support/v7/widget/j;->a:Landroid/widget/SeekBar;
    ...
    iget-object v4, p0, Landroid/support/v7/widget/j;->a:Landroid/widget/SeekBar;
    ...
    .line 177
    iget-object v4, p0, Landroid/support/v7/widget/j;->b:Landroid/graphics/drawable/Drawable;
...
.method a(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 81
    :cond_0
    iput-object p1, p0, Landroid/support/v7/widget/j;->b:Landroid/graphics/drawable/Drawable;
    ...
    .line 89
    :cond_1
    invoke-direct {p0}, Landroid/support/v7/widget/j;->d()V
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    .line 48
    invoke-super {p0, p1, p2}, Landroid/support/v7/widget/i;->a(Landroid/util/AttributeSet;I)V
    ...
    .line 54
    iget-object v2, p0, Landroid/support/v7/widget/j;->a:Landroid/widget/SeekBar;
    ...
    .line 58
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/j;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/j;->d:Landroid/graphics/PorterDuff$Mode;
    ...
    .line 63
    iput-boolean v3, p0, Landroid/support/v7/widget/j;->f:Z
    ...
    .line 68
    iput-boolean v3, p0, Landroid/support/v7/widget/j;->e:Z
