...
.field mDropDownList:Landroid/support/v7/widget/o;
...
.field private final mHideSelector:Landroid/support/v7/widget/ListPopupWindow$a;
...
.field final mResizePopupRunnable:Landroid/support/v7/widget/ListPopupWindow$e;

.field private final mScrollListener:Landroid/support/v7/widget/ListPopupWindow$c;

.field private mShowDropDownRunnable:Ljava/lang/Runnable;

.field private final mTempRect:Landroid/graphics/Rect;

.field private final mTouchInterceptor:Landroid/support/v7/widget/ListPopupWindow$d;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->mResizePopupRunnable:Landroid/support/v7/widget/ListPopupWindow$e;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->mTouchInterceptor:Landroid/support/v7/widget/ListPopupWindow$d;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->mScrollListener:Landroid/support/v7/widget/ListPopupWindow$c;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->mHideSelector:Landroid/support/v7/widget/ListPopupWindow$a;
    ...
    invoke-direct {v0, p1, p2, p3, p4}, Landroid/support/v7/widget/h;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
...
.method private buildDropDown()I
    ...
    .line 1135
    .line 1137
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/o;
    ...
    :goto_0
    invoke-virtual {p0, v5, v0}, Landroid/support/v7/widget/ListPopupWindow;->createDropDownListView(Landroid/content/Context;Z)Landroid/support/v7/widget/o;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/o;
    ...
    invoke-virtual {v0, v6}, Landroid/support/v7/widget/o;->setSelector(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0, v6}, Landroid/support/v7/widget/o;->setAdapter(Landroid/widget/ListAdapter;)V
    ...
    invoke-virtual {v0, v6}, Landroid/support/v7/widget/o;->setOnItemClickListener(Landroid/widget/AdapterView$OnItemClickListener;)V
    ...
    invoke-virtual {v0, v6}, Landroid/support/v7/widget/o;->setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V

    .line 1183
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/o;

    iget-object v6, p0, Landroid/support/v7/widget/ListPopupWindow;->mScrollListener:Landroid/support/v7/widget/ListPopupWindow$c;

    invoke-virtual {v0, v6}, Landroid/support/v7/widget/o;->setOnScrollListener(Landroid/widget/AbsListView$OnScrollListener;)V
    ...
    invoke-virtual/range {v0 .. v5}, Landroid/support/v7/widget/o;->measureHeightOfChildrenCompat(IIIII)I
    ...
    .line 1303
    iget-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/o;

    invoke-virtual {v1}, Landroid/support/v7/widget/o;->getPaddingTop()I

    move-result v1

    iget-object v2, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/o;

    .line 1304
    invoke-virtual {v2}, Landroid/support/v7/widget/o;->getPaddingBottom()I
...
.method public clearListSelection()V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/o;->setListSelectionHidden(Z)V
...
.method createDropDownListView(Landroid/content/Context;Z)Landroid/support/v7/widget/o;
    .locals 1
    ...
    invoke-direct {v0, p1, p2}, Landroid/support/v7/widget/o;-><init>(Landroid/content/Context;Z)V
...
.method public dismiss()V
    ...
    .line 754
    iput-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/o;

    .line 755
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->mHandler:Landroid/os/Handler;

    iget-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->mResizePopupRunnable:Landroid/support/v7/widget/ListPopupWindow$e;
...
.method public getSelectedItem()Ljava/lang/Object;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/o;->getSelectedItem()Ljava/lang/Object;
...
.method public getSelectedItemId()J
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/o;->getSelectedItemId()J
...
.method public getSelectedItemPosition()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/o;->getSelectedItemPosition()I
...
.method public getSelectedView()Landroid/view/View;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/o;->getSelectedView()Landroid/view/View;
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    .line 977
    :cond_5
    iget-object v4, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/o;

    .line 978
    invoke-virtual {v4, v2, v1}, Landroid/support/v7/widget/o;->lookForSelectablePosition(IZ)I
    ...
    .line 979
    :cond_6
    iget-object v3, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/o;
    ...
    invoke-virtual {v3, v6, v2}, Landroid/support/v7/widget/o;->lookForSelectablePosition(IZ)I
    ...
    .line 994
    :cond_7
    iget-object v6, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/o;

    invoke-virtual {v6, v2}, Landroid/support/v7/widget/o;->setListSelectionHidden(Z)V

    .line 997
    iget-object v6, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/o;

    invoke-virtual {v6, p1, p2}, Landroid/support/v7/widget/o;->onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/o;->requestFocusFromTouch()Z
...
.method public onKeyUp(ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v7/widget/o;->onKeyUp(ILandroid/view/KeyEvent;)Z
...
.method public performItemClick(I)Z
    ...
    .line 861
    invoke-virtual {v1}, Landroid/support/v7/widget/o;->getFirstVisiblePosition()I

    move-result v0

    sub-int v0, p1, v0

    invoke-virtual {v1, v0}, Landroid/support/v7/widget/o;->getChildAt(I)Landroid/view/View;

    move-result-object v2

    .line 862
    invoke-virtual {v1}, Landroid/support/v7/widget/o;->getAdapter()Landroid/widget/ListAdapter;
...
.method public setSelection(I)V
    ...
    .line 812
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/o;->setSelection(I)V

    .line 814
    invoke-virtual {v0}, Landroid/support/v7/widget/o;->getChoiceMode()I
    ...
    invoke-virtual {v0, p1, v1}, Landroid/support/v7/widget/o;->setItemChecked(IZ)V
...
.method public show()V
    ...
    invoke-static {v0, v4}, Landroid/support/v4/widget/l;->a(Landroid/widget/PopupWindow;I)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->mTouchInterceptor:Landroid/support/v7/widget/ListPopupWindow$d;
    ...
    invoke-virtual {v0, v5}, Landroid/support/v7/widget/o;->setSelection(I)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->mHideSelector:Landroid/support/v7/widget/ListPopupWindow$a;
