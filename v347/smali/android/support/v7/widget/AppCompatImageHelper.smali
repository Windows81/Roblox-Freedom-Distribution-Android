...
# instance fields
.field private mImageTint:Landroid/support/v7/widget/y;

.field private mInternalImageTint:Landroid/support/v7/widget/y;

.field private mTmpInfo:Landroid/support/v7/widget/y;
...
.method private applyFrameworkTintUsingColorFilter(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 195
    iget-object v1, p0, Landroid/support/v7/widget/AppCompatImageHelper;->mTmpInfo:Landroid/support/v7/widget/y;
    ...
    iput-object v1, p0, Landroid/support/v7/widget/AppCompatImageHelper;->mTmpInfo:Landroid/support/v7/widget/y;
    ...
    .line 199
    invoke-virtual {v1}, Landroid/support/v7/widget/y;->a()V
    ...
    .line 203
    iput-boolean v0, v1, Landroid/support/v7/widget/y;->d:Z

    .line 204
    iput-object v2, v1, Landroid/support/v7/widget/y;->a:Landroid/content/res/ColorStateList;
    ...
    .line 208
    iput-boolean v0, v1, Landroid/support/v7/widget/y;->c:Z

    .line 209
    iput-object v2, v1, Landroid/support/v7/widget/y;->b:Landroid/graphics/PorterDuff$Mode;

    .line 212
    :cond_2
    iget-boolean v2, v1, Landroid/support/v7/widget/y;->d:Z

    if-nez v2, :cond_3

    iget-boolean v2, v1, Landroid/support/v7/widget/y;->c:Z
    ...
    invoke-static {p1, v1, v2}, Landroid/support/v7/widget/AppCompatDrawableManager;->tintDrawable(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/y;[I)V
...
.method private shouldApplyFrameworkTintUsingColorFilter()Z
    ...
    .line 177
    iget-object v2, p0, Landroid/support/v7/widget/AppCompatImageHelper;->mInternalImageTint:Landroid/support/v7/widget/y;
...
.method applySupportImageTint()V
    ...
    .line 149
    :cond_2
    iget-object v1, p0, Landroid/support/v7/widget/AppCompatImageHelper;->mImageTint:Landroid/support/v7/widget/y;
    ...
    .line 150
    invoke-static {v0, v1, v2}, Landroid/support/v7/widget/AppCompatDrawableManager;->tintDrawable(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/y;[I)V

    goto :goto_0

    .line 152
    :cond_3
    iget-object v1, p0, Landroid/support/v7/widget/AppCompatImageHelper;->mInternalImageTint:Landroid/support/v7/widget/y;
...
.method getSupportImageTintList()Landroid/content/res/ColorStateList;
    ...
    .prologue
    .line 118
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatImageHelper;->mImageTint:Landroid/support/v7/widget/y;
...
.method setInternalImageTint(Landroid/content/res/ColorStateList;)V
    ...
    .line 161
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatImageHelper;->mInternalImageTint:Landroid/support/v7/widget/y;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/AppCompatImageHelper;->mInternalImageTint:Landroid/support/v7/widget/y;
    ...
    iput-boolean v1, v0, Landroid/support/v7/widget/y;->d:Z
...
.method setSupportImageTintList(Landroid/content/res/ColorStateList;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/AppCompatImageHelper;->mImageTint:Landroid/support/v7/widget/y;
