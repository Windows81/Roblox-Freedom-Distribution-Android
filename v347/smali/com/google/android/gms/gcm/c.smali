...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/google/android/gms/gcm/c;->d:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method static declared-synchronized a(Landroid/content/Context;)Lcom/google/android/gms/gcm/c;
    ...
    invoke-direct {v0, p0}, Lcom/google/android/gms/gcm/c;-><init>(Landroid/content/Context;)V
...
.method final a(Landroid/os/Bundle;)Z
    ...
    iget-object v5, p0, Lcom/google/android/gms/gcm/c;->b:Landroid/content/Context;
    ...
    iget-object v3, p0, Lcom/google/android/gms/gcm/c;->b:Landroid/content/Context;
    ...
    iget-object v6, p0, Lcom/google/android/gms/gcm/c;->b:Landroid/content/Context;
    ...
    iget-object v6, p0, Lcom/google/android/gms/gcm/c;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_14
    iget-object v4, p0, Lcom/google/android/gms/gcm/c;->c:Ljava/lang/String;
    ...
    :cond_15
    invoke-direct {p0}, Lcom/google/android/gms/gcm/c;->a()Landroid/os/Bundle;
    ...
    iput-object v4, p0, Lcom/google/android/gms/gcm/c;->c:Ljava/lang/String;
    ...
    iget-object v9, p0, Lcom/google/android/gms/gcm/c;->b:Landroid/content/Context;

    sget v10, Lcom/google/android/gms/gcm/b$a;->gcm_fallback_notification_channel_label:I
    ...
    iput-object v0, p0, Lcom/google/android/gms/gcm/c;->c:Ljava/lang/String;
    ...
    invoke-direct {v0, v4}, Landroid/support/v4/app/z$c;-><init>(Landroid/content/Context;)V

    invoke-virtual {v0, v11}, Landroid/support/v4/app/z$c;->a(Z)Landroid/support/v4/app/z$c;

    move-result-object v0

    invoke-virtual {v0, v2}, Landroid/support/v4/app/z$c;->a(I)Landroid/support/v4/app/z$c;
    ...
    invoke-virtual {v0, v7}, Landroid/support/v4/app/z$c;->b(Ljava/lang/CharSequence;)Landroid/support/v4/app/z$c;
    ...
    invoke-virtual {v0, v3}, Landroid/support/v4/app/z$c;->a(Landroid/net/Uri;)Landroid/support/v4/app/z$c;

    :cond_1d
    if-eqz v5, :cond_1e

    invoke-virtual {v0, v5}, Landroid/support/v4/app/z$c;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/z$c;

    :cond_1e
    invoke-virtual {v0}, Landroid/support/v4/app/z$c;->a()Landroid/app/Notification;
