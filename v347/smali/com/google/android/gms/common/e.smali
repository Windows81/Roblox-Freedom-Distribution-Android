...
.method static a(Landroid/content/Context;ILcom/google/android/gms/common/internal/h;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    .locals 5
...
.method static a(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    invoke-static {p1, p3}, Lcom/google/android/gms/common/n;->a(Landroid/app/Dialog;Landroid/content/DialogInterface$OnCancelListener;)Lcom/google/android/gms/common/n;

    move-result-object v1

    invoke-virtual {v1, v0, p2}, Lcom/google/android/gms/common/n;->show(Landroid/support/v4/app/l;Ljava/lang/String;)V
...
.method private final a(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    invoke-static {v4}, Lcom/google/android/gms/common/internal/w;->a(Z)V
    ...
    sget v2, Lcom/google/android/gms/a/a$a;->common_full_open_on_phone:I
    ...
    invoke-direct {p0, p1, v0}, Lcom/google/android/gms/common/e;->a(Landroid/content/Context;Landroid/app/NotificationManager;)Ljava/lang/String;
    ...
    invoke-virtual {v4, v5}, Landroid/support/v4/app/z$c;->a(I)Landroid/support/v4/app/z$c;
    ...
    invoke-virtual {v4, v3}, Landroid/support/v4/app/z$c;->c(Ljava/lang/CharSequence;)Landroid/support/v4/app/z$c;
    ...
    invoke-virtual {v3, v4, v5}, Landroid/support/v4/app/z$c;->a(J)Landroid/support/v4/app/z$c;

    move-result-object v3

    invoke-virtual {v3, v6}, Landroid/support/v4/app/z$c;->a(Z)Landroid/support/v4/app/z$c;

    move-result-object v3

    invoke-virtual {v3, p4}, Landroid/support/v4/app/z$c;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/z$c;

    move-result-object v3

    invoke-virtual {v3, v1}, Landroid/support/v4/app/z$c;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/z$c;

    move-result-object v1

    invoke-virtual {v1, v2}, Landroid/support/v4/app/z$c;->b(Ljava/lang/CharSequence;)Landroid/support/v4/app/z$c;

    move-result-object v1

    invoke-virtual {v1, v6}, Landroid/support/v4/app/z$c;->b(Z)Landroid/support/v4/app/z$c;

    move-result-object v1

    new-instance v3, Landroid/support/v4/app/z$b;

    invoke-direct {v3}, Landroid/support/v4/app/z$b;-><init>()V

    invoke-virtual {v3, v2}, Landroid/support/v4/app/z$b;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/z$b;

    move-result-object v2

    invoke-virtual {v1, v2}, Landroid/support/v4/app/z$c;->a(Landroid/support/v4/app/z$d;)Landroid/support/v4/app/z$c;
    ...
    invoke-virtual {v1, v2}, Landroid/support/v4/app/z$c;->a(Ljava/lang/String;)Landroid/support/v4/app/z$c;
    ...
    sget-object v3, Lcom/google/android/gms/common/k;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public a(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-virtual {p0, p1, p2, v0}, Lcom/google/android/gms/common/f;->b(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;

    move-result-object v0

    invoke-static {p1, v0, p3}, Lcom/google/android/gms/common/internal/h;->a(Landroid/app/Activity;Landroid/content/Intent;I)Lcom/google/android/gms/common/internal/h;

    move-result-object v0

    invoke-static {p1, p2, v0, p4}, Lcom/google/android/gms/common/e;->a(Landroid/content/Context;ILcom/google/android/gms/common/internal/h;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
...
.method public a(Landroid/app/Activity;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p1, v0}, Lcom/google/android/gms/common/internal/f;->c(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-static {p1, v0, v1, p2}, Lcom/google/android/gms/common/e;->a(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
...
.method public a(Landroid/content/Context;Lcom/google/android/gms/common/ConnectionResult;)Landroid/app/PendingIntent;
    ...
    invoke-virtual {p0, p1, v0, v1}, Lcom/google/android/gms/common/f;->a(Landroid/content/Context;II)Landroid/app/PendingIntent;
...
.method public a(Landroid/content/Context;Lcom/google/android/gms/common/api/internal/c$a;)Lcom/google/android/gms/common/api/internal/c;
    .locals 2
    ...
    invoke-direct {v0, p2}, Lcom/google/android/gms/common/api/internal/c;-><init>(Lcom/google/android/gms/common/api/internal/c$a;)V

    invoke-virtual {p1, v0, v1}, Landroid/content/Context;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;

    invoke-virtual {v0, p1}, Lcom/google/android/gms/common/api/internal/c;->a(Landroid/content/Context;)V

    const-string v1, "com.google.android.gms"

    invoke-virtual {p0, p1, v1}, Lcom/google/android/gms/common/f;->a(Landroid/content/Context;Ljava/lang/String;)Z

    move-result v1

    if-nez v1, :cond_0

    invoke-virtual {p2}, Lcom/google/android/gms/common/api/internal/c$a;->a()V
...
.method public a(Landroid/content/Context;I)V
    ...
    invoke-virtual {p0, p1, p2, v0}, Lcom/google/android/gms/common/e;->a(Landroid/content/Context;ILjava/lang/String;)V
...
.method public a(Landroid/app/Activity;Lcom/google/android/gms/common/api/internal/e;IILandroid/content/DialogInterface$OnCancelListener;)Z
    .locals 2

    const-string v0, "d"

    invoke-virtual {p0, p1, p3, v0}, Lcom/google/android/gms/common/f;->b(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;

    move-result-object v0

    invoke-static {p2, v0, p4}, Lcom/google/android/gms/common/internal/h;->a(Lcom/google/android/gms/common/api/internal/e;Landroid/content/Intent;I)Lcom/google/android/gms/common/internal/h;

    move-result-object v0

    invoke-static {p1, p3, v0, p5}, Lcom/google/android/gms/common/e;->a(Landroid/content/Context;ILcom/google/android/gms/common/internal/h;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
