...
.method public a()V
    ...
    .line 21
    :try_start_0
    invoke-virtual {p0}, Lcom/appsflyer/j;->getApplicationContext()Landroid/content/Context;
    ...
    .line 29
    invoke-static {v1}, Lcom/appsflyer/n;->a(Ljava/lang/String;)Lcom/appsflyer/n;

    move-result-object v1

    .line 30
    new-instance v4, Lcom/appsflyer/n;

    invoke-direct {v4, v2, v3, v0}, Lcom/appsflyer/n;-><init>(JLjava/lang/String;)V

    .line 31
    if-eqz v1, :cond_0

    invoke-virtual {v1, v4}, Lcom/appsflyer/n;->a(Lcom/appsflyer/n;)Z
    ...
    invoke-static {v0, v4}, Lcom/appsflyer/m;->a(Landroid/content/Context;Lcom/appsflyer/n;)V
