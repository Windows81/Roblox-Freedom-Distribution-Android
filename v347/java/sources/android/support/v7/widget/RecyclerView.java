...
public class RecyclerView extends ViewGroup implements android.support.v4.view.j {
    ...
    public RecyclerView(Context context, AttributeSet attributeSet, int i) throws NoSuchMethodException {
        ...
        this.mPrefetchRegistry = ALLOW_THREAD_GAP_WORK ? new q.a() : null;
        ...
        this.mScaledHorizontalScrollFactor = android.support.v4.view.t.a(viewConfiguration, context);
        this.mScaledVerticalScrollFactor = android.support.v4.view.t.b(viewConfiguration, context);
        ...
        if (attributeSet != null) {
            TypedArray typedArrayObtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, a.c.RecyclerView, i, 0);
            String string = typedArrayObtainStyledAttributes2.getString(a.c.RecyclerView_layoutManager);
            if (typedArrayObtainStyledAttributes2.getInt(a.c.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = typedArrayObtainStyledAttributes2.getBoolean(a.c.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) typedArrayObtainStyledAttributes2.getDrawable(a.c.RecyclerView_fastScrollVerticalThumbDrawable), typedArrayObtainStyledAttributes2.getDrawable(a.c.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) typedArrayObtainStyledAttributes2.getDrawable(a.c.RecyclerView_fastScrollHorizontalThumbDrawable), typedArrayObtainStyledAttributes2.getDrawable(a.c.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
    ...
    public void setAccessibilityDelegateCompat(RecyclerViewAccessibilityDelegate recyclerViewAccessibilityDelegate) {
        ...
        android.support.v4.view.s.a(this, this.mAccessibilityDelegate);
    }
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new n(new n.b() { // from class: android.support.v7.widget.RecyclerView.5
            ...
            public void b() {
                ...
                for (int i = 0; i < iA; i++) {
                    View viewB = b(i);
                    RecyclerView.this.dispatchChildDetached(viewB);
            ...
            public void c(int i) {
                ...
                View viewB = b(i);
                if (viewB != null && (childViewHolderInt = RecyclerView.getChildViewHolderInt(viewB)) != null) {
                    if (childViewHolderInt.isTmpDetached() && !childViewHolderInt.shouldIgnore()) {
    ...
    void initAdapterManager() {
        this.mAdapterHelper = new android.support.v7.widget.d(new d.a() { // from class: android.support.v7.widget.RecyclerView.6
            ...
            public ViewHolder a(int i) {
                ...
                if (viewHolderFindViewHolderForPosition == null || RecyclerView.this.mChildHelper.c(viewHolderFindViewHolderForPosition.itemView)) {
                    return null;
                }
            ...
            void c(d.b bVar) {
                switch (bVar.f1636a) {
                    case 1:
                        RecyclerView.this.mLayout.onItemsAdded(RecyclerView.this, bVar.f1637b, bVar.f1639d);
                        break;
                    case 2:
                        RecyclerView.this.mLayout.onItemsRemoved(RecyclerView.this, bVar.f1637b, bVar.f1639d);
                        break;
                    case 4:
                        RecyclerView.this.mLayout.onItemsUpdated(RecyclerView.this, bVar.f1637b, bVar.f1639d, bVar.f1638c);
                        break;
                    case 8:
                        RecyclerView.this.mLayout.onItemsMoved(RecyclerView.this, bVar.f1637b, bVar.f1639d, 1);
                        break;
                }
            }
    ...
    void consumePendingUpdateOperations() {
        if (!this.mFirstLayoutComplete || this.mDataSetHasChangedAfterLayout) {
            android.support.v4.os.e.a(TRACE_ON_DATA_SET_CHANGE_LAYOUT_TAG);
            dispatchLayout();
        ...
        if (this.mAdapterHelper.d()) {
            if (this.mAdapterHelper.a(4) && !this.mAdapterHelper.a(11)) {
                android.support.v4.os.e.a(TRACE_HANDLE_ADAPTER_UPDATES_TAG);
                eatRequestLayout();
    ...
    boolean scrollByInternal(int i, int i2, MotionEvent motionEvent) {
        ...
        if (this.mAdapter != null) {
            ...
            i5 = i7;
            i4 = iScrollHorizontallyBy;
            i3 = iScrollVerticallyBy;
        } else {
            i3 = 0;
            i4 = 0;
            i5 = 0;
    ...
    public void smoothScrollBy(int i, int i2, Interpolator interpolator) {
        ...
        if (!this.mLayoutFrozen) {
            ...
            if (i != 0 || i3 != 0) {
                this.mViewFlinger.a(i, i3, interpolator);
            }
        }
    }
    ...
    private void pullGlows(float f, float f2, float f3, float f4) {
        ...
        if (f2 < 0.0f) {
            ensureLeftGlow();
            android.support.v4.widget.h.a(this.mLeftGlow, (-f2) / getWidth(), 1.0f - (f3 / getHeight()));
            z2 = true;
        } else if (f2 > 0.0f) {
            ensureRightGlow();
            android.support.v4.widget.h.a(this.mRightGlow, f2 / getWidth(), f3 / getHeight());
            z2 = true;
        }
        if (f4 < 0.0f) {
            ensureTopGlow();
            android.support.v4.widget.h.a(this.mTopGlow, (-f4) / getHeight(), f / getWidth());
        } else if (f4 > 0.0f) {
            ensureBottomGlow();
            android.support.v4.widget.h.a(this.mBottomGlow, f4 / getHeight(), 1.0f - (f / getWidth()));
        } else {
            z = z2;
        }
    ...
    public View focusSearch(View view, int i) {
        ...
        if (!isPreferredNextFocus(view, viewOnFocusSearchFailed, i)) {
    ...
    */
    protected void onAttachedToWindow() {
        ...
        L1e:
            ...
            if (r0 == 0) goto L67
            java.lang.ThreadLocal<android.support.v7.widget.q> r0 = android.support.v7.widget.q.f1698a
            java.lang.Object r0 = r0.get()
            android.support.v7.widget.q r0 = (android.support.v7.widget.q) r0
            r4.mGapWorker = r0
            android.support.v7.widget.q r0 = r4.mGapWorker
            if (r0 != 0) goto L62
            android.support.v7.widget.q r0 = new android.support.v7.widget.q
            r0.<init>()
            r4.mGapWorker = r0
            android.view.Display r0 = android.support.v4.view.s.A(r4)
            ...
            if (r2 < 0) goto L6a
        L51:
            android.support.v7.widget.q r1 = r4.mGapWorker
        ...
        switch (actionMasked) {
            ...
            case 2:
                ...
                if (this.mScrollState == 1) {
                    ...
                    if (scrollByInternal(zCanScrollHorizontally ? i4 : 0, zCanScrollVertically ? i5 : 0, motionEventObtain)) {
                        getParent().requestDisallowInterceptTouchEvent(true);
                    }
                    if (this.mGapWorker != null && (i4 != 0 || i5 != 0)) {
                        this.mGapWorker.a(this, i4, i5);
                    }
                }
                break;
                break;
    ...
    void defaultOnMeasure(int i, int i2) {
        setMeasuredDimension(LayoutManager.chooseSize(i, getPaddingLeft() + getPaddingRight(), android.support.v4.view.s.h(this)), LayoutManager.chooseSize(i2, getPaddingTop() + getPaddingBottom(), android.support.v4.view.s.i(this)));
    }
    ...
    private void dispatchContentChangedIfNecessary() {
        ...
        if (i != 0 && isAccessibilityEnabled()) {
            ...
            android.support.v4.view.a.a.a(accessibilityEventObtain, i);
    ...
    boolean shouldDeferAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        ...
        int iA = accessibilityEvent != null ? android.support.v4.view.a.a.a(accessibilityEvent) : 0;
        this.mEatenAccessibilityChangeFlags = (iA != 0 ? iA : 0) | this.mEatenAccessibilityChangeFlags;
        return true;
    }
    ...
    void postAnimationRunner() {
        if (!this.mPostedAnimatorRunner && this.mIsAttached) {
            android.support.v4.view.s.a(this, this.mItemAnimatorRunner);
    ...
    private void recoverFocusFromState() {
        ...
        if (this.mPreserveFocusAfterLayout && this.mAdapter != null && hasFocus() && getDescendantFocusability() != 393216) {
            if (getDescendantFocusability() != 131072 || !isFocused()) {
                ...
                if (viewHolderFindViewHolderForItemId == null || this.mChildHelper.c(viewHolderFindViewHolderForItemId.itemView) || !viewHolderFindViewHolderForItemId.itemView.hasFocusable()) {
                    if (this.mChildHelper.b() > 0) {
            ...
            for (int i2 = 0; i2 < this.mChildHelper.b(); i2++) {
                ...
                if (!childViewHolderInt2.shouldIgnore() && !this.mViewInfoStore.d(childViewHolderInt2)) {
                    ...
                    if (zHasAnyOfTheFlags) {
                        ...
                        this.mViewInfoStore.b(childViewHolderInt2, itemHolderInfoRecordPreLayoutInformation);
                    }
                }
            }
            clearOldPositions();
    ...
    private void dispatchLayoutStep3() {
        ...
        if (this.mState.mRunSimpleAnimations) {
            for (int iB = this.mChildHelper.b() - 1; iB >= 0; iB--) {
                ViewHolder childViewHolderInt = getChildViewHolderInt(this.mChildHelper.b(iB));
                if (!childViewHolderInt.shouldIgnore()) {
                    ...
                    ViewHolder viewHolderA = this.mViewInfoStore.a(changedHolderKey);
                    if (viewHolderA != null && !viewHolderA.shouldIgnore()) {
                        boolean zA = this.mViewInfoStore.a(viewHolderA);
                        boolean zA2 = this.mViewInfoStore.a(childViewHolderInt);
                        if (zA && viewHolderA == childViewHolderInt) {
                            this.mViewInfoStore.c(childViewHolderInt, itemHolderInfoRecordPostLayoutInformation);
                        } else {
                            ItemAnimator.ItemHolderInfo itemHolderInfoB = this.mViewInfoStore.b(viewHolderA);
                            this.mViewInfoStore.c(childViewHolderInt, itemHolderInfoRecordPostLayoutInformation);
                            ItemAnimator.ItemHolderInfo itemHolderInfoC = this.mViewInfoStore.c(childViewHolderInt);
                            if (itemHolderInfoB == null) {
                                handleMissingPreInfoForChangeError(changedHolderKey, childViewHolderInt, viewHolderA);
                            } else {
                                animateChange(viewHolderA, childViewHolderInt, itemHolderInfoB, itemHolderInfoC, zA, zA2);
                            }
                        }
                    } else {
                        this.mViewInfoStore.c(childViewHolderInt, itemHolderInfoRecordPostLayoutInformation);
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        android.support.v4.os.e.a(TRACE_ON_LAYOUT_TAG);
        dispatchLayout();
        android.support.v4.os.e.a();
    ...
    void markItemDecorInsetsDirty() {
        ...
        for (int i = 0; i < iC; i++) {
            ((LayoutParams) this.mChildHelper.d(i).getLayoutParams()).mInsetsDirty = true;
        }
    ...
    void viewRangeUpdate(int i, int i2, Object obj) {
        ...
        int i3 = i + i2;
        for (int i4 = 0; i4 < iC; i4++) {
            View viewD = this.mChildHelper.d(i4);
            ViewHolder childViewHolderInt = getChildViewHolderInt(viewD);
            if (childViewHolderInt != null && !childViewHolderInt.shouldIgnore() && childViewHolderInt.mPosition >= i && childViewHolderInt.mPosition < i3) {
                ...
                ((LayoutParams) viewD.getLayoutParams()).mInsetsDirty = true;
            }
        }
    ...
    */
    ...
    public View findChildViewUnder(float f, float f2) {
        for (int iB = this.mChildHelper.b() - 1; iB >= 0; iB--) {
            View viewB = this.mChildHelper.b(iB);
            float translationX = viewB.getTranslationX();
            float translationY = viewB.getTranslationY();
            if (f >= viewB.getLeft() + translationX && f <= translationX + viewB.getRight() && f2 >= viewB.getTop() + translationY && f2 <= viewB.getBottom() + translationY) {
                return viewB;
            }
        }
        return null;
    ...
    class d implements Runnable {
        ...
        Interpolator f1537a = RecyclerView.sQuinticInterpolator;
        private boolean f = false;
        private boolean g = false;

        d() {
            this.e = new OverScroller(RecyclerView.this.getContext(), RecyclerView.sQuinticInterpolator);
        }
        ...
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                int i10 = currX - this.f1539c;
                int i11 = currY - this.f1540d;
                this.f1539c = currX;
                this.f1540d = currY;
                ...
                if (RecyclerView.this.mAdapter == null) {
                    ...
                    android.support.v4.os.e.a(RecyclerView.TRACE_SCROLL_TAG);
                    RecyclerView.this.fillRemainingScrollValues(RecyclerView.this.mState);
                    if (i2 == 0) {
                        i4 = 0;
                        iScrollHorizontallyBy = 0;
                    } else {
                        iScrollHorizontallyBy = RecyclerView.this.mLayout.scrollHorizontallyBy(i2, RecyclerView.this.mRecycler, RecyclerView.this.mState);
                        i4 = i2 - iScrollHorizontallyBy;
                    }
                    if (i == 0) {
                        i9 = 0;
                        iScrollVerticallyBy = 0;
                    } else {
                        iScrollVerticallyBy = RecyclerView.this.mLayout.scrollVerticallyBy(i, RecyclerView.this.mRecycler, RecyclerView.this.mState);
                        i9 = i - iScrollVerticallyBy;
                    }
                    android.support.v4.os.e.a();
                    ...
                    if (smoothScroller == null || smoothScroller.isPendingInitialRun() || !smoothScroller.isRunning()) {
                        i3 = i9;
                        int i13 = iScrollVerticallyBy;
                        i6 = iScrollHorizontallyBy;
                        i5 = i13;
                    } else {
                        ...
                        if (itemCount == 0) {
                            smoothScroller.stop();
                            i3 = i9;
                            int i14 = iScrollVerticallyBy;
                            i6 = iScrollHorizontallyBy;
                            i5 = i14;
                        } else if (smoothScroller.getTargetPosition() >= itemCount) {
                            smoothScroller.setTargetPosition(itemCount - 1);
                            smoothScroller.onAnimation(i2 - i4, i - i9);
                            i3 = i9;
                            int i15 = iScrollVerticallyBy;
                            i6 = iScrollHorizontallyBy;
                            i5 = i15;
                        } else {
                            smoothScroller.onAnimation(i2 - i4, i - i9);
                            i3 = i9;
                            int i132 = iScrollVerticallyBy;
                            i6 = iScrollHorizontallyBy;
                            i5 = i132;
                        }
                    }
        ...
        private int b(int i, int i2, int i3, int i4) {
            ...
            int i5 = width / 2;
            float fA = (a(Math.min(1.0f, (iSqrt2 * 1.0f) / width)) * i5) + i5;
            if (iSqrt > 0) {
                iRound = Math.round(1000.0f * Math.abs(fA / iSqrt)) * 4;
            } else {
        ...
        public void a(int i, int i2, int i3, Interpolator interpolator) {
            if (this.f1537a != interpolator) {
                this.f1537a = interpolator;
    ...
    void repositionShadowingViews() {
        int iB = this.mChildHelper.b();
        for (int i = 0; i < iB; i++) {
            View viewB = this.mChildHelper.b(i);
    ...
    private class c extends AdapterDataObserver {
        ...
        void a() {
            if (RecyclerView.POST_UPDATES_ON_ANIMATION && RecyclerView.this.mHasFixedSize && RecyclerView.this.mIsAttached) {
                android.support.v4.view.s.a(RecyclerView.this, RecyclerView.this.mUpdateChildViewsRunnable);
            } else {
    ...
    public static class RecycledViewPool {
        ...
        static class a {
            ...
            /* JADX INFO: renamed from: a, reason: collision with root package name */
            ArrayList<ViewHolder> f1531a = new ArrayList<>();
        ...
        public void clear() {
            ...
            while (true) {
                ...
                if (i2 < this.mScrap.size()) {
                    this.mScrap.valueAt(i2).f1531a.clear();
                    i = i2 + 1;
                } else {
                    return;
                }
        ...
        public void setMaxRecycledViews(int i, int i2) {
            ...
            scrapDataForType.f1532b = i2;
            ArrayList<ViewHolder> arrayList = scrapDataForType.f1531a;
            if (arrayList != null) {
        ...
        public int getRecycledViewCount(int i) {
            return getScrapDataForType(i).f1531a.size();
        }

        public ViewHolder getRecycledView(int i) {
            a aVar = this.mScrap.get(i);
            if (aVar == null || aVar.f1531a.isEmpty()) {
                return null;
            }
            return aVar.f1531a.remove(r0.size() - 1);
        }

        int size() {
            int size = 0;
            for (int i = 0; i < this.mScrap.size(); i++) {
                ArrayList<ViewHolder> arrayList = this.mScrap.valueAt(i).f1531a;
                if (arrayList != null) {
                    size += arrayList.size();
                }
            }
        ...
        public void putRecycledView(ViewHolder viewHolder) {
            ...
            ArrayList<ViewHolder> arrayList = getScrapDataForType(itemViewType).f1531a;
            if (this.mScrap.get(itemViewType).f1532b > arrayList.size()) {
        ...
        void factorInCreateTime(int i, long j) {
            a scrapDataForType = getScrapDataForType(i);
            scrapDataForType.f1533c = runningAverage(scrapDataForType.f1533c, j);
        }

        void factorInBindTime(int i, long j) {
            a scrapDataForType = getScrapDataForType(i);
            scrapDataForType.f1534d = runningAverage(scrapDataForType.f1534d, j);
        }

        boolean willCreateInTime(int i, long j, long j2) {
            long j3 = getScrapDataForType(i).f1533c;
            return j3 == 0 || j3 + j < j2;
        }

        boolean willBindInTime(int i, long j, long j2) {
            long j3 = getScrapDataForType(i).f1534d;
            return j3 == 0 || j3 + j < j2;
        }
    ...
    public final class Recycler {
        ...
        public void bindViewToPosition(View view, int i) {
            ...
            int iB = RecyclerView.this.mAdapterHelper.b(i);
            if (iB < 0 || iB >= RecyclerView.this.mAdapter.getItemCount()) {
                throw new IndexOutOfBoundsException("Inconsistency detected. Invalid item position " + i + "(offset:" + iB + ").state:" + RecyclerView.this.mState.getItemCount() + RecyclerView.this.exceptionLabel());
            }
            tryBindViewHolderByDeadline(childViewHolderInt, iB, i, RecyclerView.FOREVER_NS);
        ...
        ViewHolder tryGetViewHolderForPositionByDeadline(int i, boolean z, long j) {
            ...
            if (RecyclerView.this.mState.isPreLayout()) {
                ...
                viewHolderCreateViewHolder = changedScrapViewForPosition;
            } else {
            ...
            if (viewHolderCreateViewHolder == null) {
                ...
                int itemViewType = RecyclerView.this.mAdapter.getItemViewType(iB);
                if (!RecyclerView.this.mAdapter.hasStableIds() || (viewHolderCreateViewHolder = getScrapOrCachedViewForId(RecyclerView.this.mAdapter.getItemId(iB), itemViewType, z)) == null) {
                    z4 = z2;
                } else {
                    viewHolderCreateViewHolder.mPosition = iB;
                    z4 = true;
                }
                if (viewHolderCreateViewHolder == null && this.mViewCacheExtension != null && (viewForPositionAndType = this.mViewCacheExtension.getViewForPositionAndType(this, i, itemViewType)) != null) {
                ...
                if (viewHolderCreateViewHolder == null && (viewHolderCreateViewHolder = getRecycledViewPool().getRecycledView(itemViewType)) != null) {
            ...
            if (RecyclerView.this.mState.isPreLayout() && viewHolder.isBound()) {
                ...
                zTryBindViewHolderByDeadline = (!viewHolder.isBound() || viewHolder.needsUpdate() || viewHolder.isInvalid()) ? tryBindViewHolderByDeadline(viewHolder, RecyclerView.this.mAdapterHelper.b(i), i, j) : false;
            }
            ...
            layoutParams.mPendingInvalidate = z3 && zTryBindViewHolderByDeadline;
            return viewHolder;
        }
        ...
        private void attachAccessibilityDelegateOnBind(ViewHolder viewHolder) {
            if (RecyclerView.this.isAccessibilityEnabled()) {
                ...
                if (!android.support.v4.view.s.a(view)) {
                    ...
                    android.support.v4.view.s.a(view, RecyclerView.this.mAccessibilityDelegate.getItemDelegate());
                }
            }
        }
            ...
            if ((RecyclerView.this.mAdapter != null && zDoesTransientStatePreventRecycling && RecyclerView.this.mAdapter.onFailedToRecycleView(viewHolder)) || viewHolder.isRecyclable()) {
                if (this.mViewCacheMax <= 0 || viewHolder.hasAnyOfTheFlags(526)) {
                    ...
                    if (RecyclerView.ALLOW_THREAD_GAP_WORK && size > 0 && !RecyclerView.this.mPrefetchRegistry.a(viewHolder.mPosition)) {
                        int i = size - 1;
                        while (i >= 0) {
                            if (!RecyclerView.this.mPrefetchRegistry.a(this.mCachedViews.get(i).mPosition)) {
                                break;
                            } else {
                                i--;
                            }
        ...
        void addViewHolderToRecycledViewPool(ViewHolder viewHolder, boolean z) {
            ...
            if (viewHolder.hasAnyOfTheFlags(16384)) {
                ...
                android.support.v4.view.s.a(viewHolder.itemView, (android.support.v4.view.a) null);
            }
            if (z) {
        ...
        ViewHolder getChangedScrapViewForPosition(int i) {
            ...
            if (RecyclerView.this.mAdapter.hasStableIds() && (iB = RecyclerView.this.mAdapterHelper.b(i)) > 0 && iB < RecyclerView.this.mAdapter.getItemCount()) {
        ...
        ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int i, boolean z) {
            ...
            if (!z && (viewC = RecyclerView.this.mChildHelper.c(i)) != null) {
                ViewHolder childViewHolderInt = RecyclerView.getChildViewHolderInt(viewC);
                RecyclerView.this.mChildHelper.e(viewC);
                int iB = RecyclerView.this.mChildHelper.b(viewC);
                if (iB == -1) {
                    throw new IllegalStateException("layout index should not be -1 after unhiding a view:" + childViewHolderInt + RecyclerView.this.exceptionLabel());
                }
                RecyclerView.this.mChildHelper.e(iB);
                scrapView(viewC);
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public final VH createViewHolder(ViewGroup viewGroup, int i) {
            android.support.v4.os.e.a(RecyclerView.TRACE_CREATE_VIEW_TAG);
        ...
        public final void bindViewHolder(VH vh, int i) {
            ...
            vh.setFlags(1, 519);
            android.support.v4.os.e.a(RecyclerView.TRACE_BIND_VIEW_TAG);
    ...
    public static abstract class LayoutManager {
        ...
        public void postOnAnimation(Runnable runnable) {
            if (this.mRecyclerView != null) {
                android.support.v4.view.s.a(this.mRecyclerView, runnable);
            }
        }
        ...
        public int getLayoutDirection() {
            return android.support.v4.view.s.e(this.mRecyclerView);
        }
        ...
        private void addViewInt(View view, int i, boolean z) {
            ...
            if (childViewHolderInt.wasReturnedFromScrap() || childViewHolderInt.isScrap()) {
                ...
                int iB = this.mChildHelper.b(view);
                if (i == -1) {
                ...
                if (iB != i) {
                    this.mRecyclerView.mLayout.moveView(iB, i);
                }
            } else {
        ...
        public View findContainingItemView(View view) {
            ...
            if (this.mRecyclerView == null || (viewFindContainingItemView = this.mRecyclerView.findContainingItemView(view)) == null || this.mChildHelper.c(viewFindContainingItemView)) {
                return null;
            }
        ...
        public int getPaddingStart() {
            if (this.mRecyclerView != null) {
                return android.support.v4.view.s.f(this.mRecyclerView);
            }
            return 0;
        }
        ...
        public int getPaddingEnd() {
            if (this.mRecyclerView != null) {
                return android.support.v4.view.s.g(this.mRecyclerView);
            }
            return 0;
        }
        ...
        */
        ...
        private int[] getChildRectangleOnScreenScrollAmount(RecyclerView recyclerView, View view, Rect rect, boolean z) {
            ...
            int iMin2 = Math.min(0, left - paddingLeft);
            int iMin3 = Math.min(0, top - paddingTop);
            int iMax = Math.max(0, iWidth - width);
            int iMax2 = Math.max(0, iHeight - height);
            if (getLayoutDirection() == 1) {
                if (iMax == 0) {
                    iMax = Math.max(iMin2, iWidth - width);
                }
                iMin = iMax;
            } else {
                iMin = iMin2 != 0 ? iMin2 : Math.min(left - paddingLeft, iMax);
            }
            int iMin4 = iMin3 != 0 ? iMin3 : Math.min(top - paddingTop, iMax2);
            iArr[0] = iMin;
            iArr[1] = iMin4;
            return iArr;
        }
        ...
        public int getMinimumWidth() {
            return android.support.v4.view.s.h(this.mRecyclerView);
        }

        public int getMinimumHeight() {
            return android.support.v4.view.s.i(this.mRecyclerView);
        }
        ...
        void onInitializeAccessibilityNodeInfo(android.support.v4.view.a.b bVar) {
            onInitializeAccessibilityNodeInfo(this.mRecyclerView.mRecycler, this.mRecyclerView.mState, bVar);
        }

        public void onInitializeAccessibilityNodeInfo(Recycler recycler, State state, android.support.v4.view.a.b bVar) {
            if (this.mRecyclerView.canScrollVertically(-1) || this.mRecyclerView.canScrollHorizontally(-1)) {
                bVar.a(8192);
                bVar.c(true);
            }
            if (this.mRecyclerView.canScrollVertically(1) || this.mRecyclerView.canScrollHorizontally(1)) {
                bVar.a(ItemAnimator.FLAG_APPEARED_IN_PRE_LAYOUT);
                bVar.c(true);
            }
            bVar.a(b.a.a(getRowCountForAccessibility(recycler, state), getColumnCountForAccessibility(recycler, state), isLayoutHierarchical(recycler, state), getSelectionModeForAccessibility(recycler, state)));
        }
        ...
        void onInitializeAccessibilityNodeInfoForItem(View view, android.support.v4.view.a.b bVar) {
            ViewHolder childViewHolderInt = RecyclerView.getChildViewHolderInt(view);
        ...
        public void onInitializeAccessibilityNodeInfoForItem(Recycler recycler, State state, View view, android.support.v4.view.a.b bVar) {
            bVar.b(b.C0028b.a(canScrollVertically() ? getPosition(view) : 0, 1, canScrollHorizontally() ? getPosition(view) : 0, 1, false, false));
        }
  ...
  0x007a: PHI (r0v9 int) = (r0v4 int), (r0v14 int) binds: [B:20:0x0066, B:14:0x0035] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        */
        ...
        public static Properties getProperties(Context context, AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, a.c.RecyclerView, i, i2);
            properties.orientation = typedArrayObtainStyledAttributes.getInt(a.c.RecyclerView_android_orientation, 1);
            properties.spanCount = typedArrayObtainStyledAttributes.getInt(a.c.RecyclerView_spanCount, 1);
            properties.reverseLayout = typedArrayObtainStyledAttributes.getBoolean(a.c.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = typedArrayObtainStyledAttributes.getBoolean(a.c.RecyclerView_stackFromEnd, false);
            typedArrayObtainStyledAttributes.recycle();
            return properties;
        }
    ...
    public static abstract class ViewHolder {
        ...
        public void onEnteredHiddenState(RecyclerView recyclerView) {
            this.mWasImportantForAccessibilityBeforeHidden = android.support.v4.view.s.d(this.itemView);
        ...
        public final boolean isRecyclable() {
            return (this.mFlags & 16) == 0 && !android.support.v4.view.s.b(this.itemView);
        }
    ...
    boolean setChildImportantForAccessibilityInternal(ViewHolder viewHolder, int i) {
        ...
        android.support.v4.view.s.a(viewHolder.itemView, i);
        return true;
    }
    ...
    void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        new p(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(a.C0035a.fastscroll_default_thickness), resources.getDimensionPixelSize(a.C0035a.fastscroll_minimum_range), resources.getDimensionPixelOffset(a.C0035a.fastscroll_margin));
    }
                ...
                if (this.mChanged) {
                    ...
                    if (this.mInterpolator == null) {
                        if (this.mDuration == Integer.MIN_VALUE) {
                            recyclerView.mViewFlinger.b(this.mDx, this.mDy);
                        } else {
                            recyclerView.mViewFlinger.a(this.mDx, this.mDy, this.mDuration);
                        }
                    } else {
                        recyclerView.mViewFlinger.a(this.mDx, this.mDy, this.mDuration, this.mInterpolator);
                    }
