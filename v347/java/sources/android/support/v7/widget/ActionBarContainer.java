...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        android.support.v4.view.s.a(this, Build.VERSION.SDK_INT >= 21 ? new b(this) : new a(this));
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, a.j.ActionBar);
        this.mBackground = typedArrayObtainStyledAttributes.getDrawable(a.j.ActionBar_background);
        this.mStackedBackground = typedArrayObtainStyledAttributes.getDrawable(a.j.ActionBar_backgroundStacked);
        this.mHeight = typedArrayObtainStyledAttributes.getDimensionPixelSize(a.j.ActionBar_height, -1);
        if (getId() == a.f.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = typedArrayObtainStyledAttributes.getDrawable(a.j.ActionBar_backgroundSplit);
        }
