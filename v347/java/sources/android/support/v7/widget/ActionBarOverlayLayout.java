...
public class ActionBarOverlayLayout extends ViewGroup implements android.support.v4.view.l, DecorContentParent {
    static final int[] ATTRS = {a.C0032a.actionBarSize, R.attr.windowContentOverlay};
    ...
    private final android.support.v4.view.n mParentHelper;
    ...
    protected boolean fitSystemWindows(Rect rect) {
        pullChildren();
        if ((android.support.v4.view.s.m(this) & 256) != 0) {
        }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        boolean z = (android.support.v4.view.s.m(this) & 256) != 0;
        if (z) {
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(a.f.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(a.f.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(a.f.action_bar));
        }
    }
