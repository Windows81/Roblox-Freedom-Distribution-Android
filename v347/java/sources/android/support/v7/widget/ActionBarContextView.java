...
public class ActionBarContextView extends AbsActionBarView {
    ...
    @Override // android.support.v7.widget.AbsActionBarView
    public /* bridge */ /* synthetic */ android.support.v4.view.w setupAnimatorToVisibility(int i, long j) {
    ...
    public ActionBarContextView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, a.C0032a.actionModeStyle);
    }

    public ActionBarContextView(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, a.j.ActionMode, i, 0);
        android.support.v4.view.s.a(this, tintTypedArrayObtainStyledAttributes.getDrawable(a.j.ActionMode_background));
        this.mTitleStyleRes = tintTypedArrayObtainStyledAttributes.getResourceId(a.j.ActionMode_titleTextStyle, 0);
        this.mSubtitleStyleRes = tintTypedArrayObtainStyledAttributes.getResourceId(a.j.ActionMode_subtitleTextStyle, 0);
        this.mContentHeight = tintTypedArrayObtainStyledAttributes.getLayoutDimension(a.j.ActionMode_height, 0);
        this.mCloseItemLayout = tintTypedArrayObtainStyledAttributes.getResourceId(a.j.ActionMode_closeItemLayout, a.g.abc_action_mode_close_item_material);
    ...
    public void initForMode(final android.support.v7.view.b bVar) {
        if (this.mClose == null) {
        ...
        this.mClose.findViewById(a.f.action_mode_close_button).setOnClickListener(new View.OnClickListener() { // from class: android.support.v7.widget.ActionBarContextView.1
        ...
        hVar.a(this.mActionMenuPresenter, this.mPopupContext);
        this.mMenuView = (ActionMenuView) this.mActionMenuPresenter.a(this);
        android.support.v4.view.s.a(this.mMenuView, (Drawable) null);
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.mCustomView != null) {
            int iPositionChild2 = positionChild(this.mCustomView, iPositionChild, paddingTop, paddingTop2, zIsLayoutRtl) + iPositionChild;
        }
