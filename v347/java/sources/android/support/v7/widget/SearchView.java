...
public class SearchView extends LinearLayoutCompat implements android.support.v7.view.c {
    ...
    android.support.v4.widget.f mSuggestionsAdapter;
    private int[] mTemp;
    private int[] mTemp2;
    ...
    public SearchView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, a.C0032a.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mReleaseCursorRunnable = new Runnable() { // from class: android.support.v7.widget.SearchView.3
            @Override // java.lang.Runnable
            public void run() {
                if (SearchView.this.mSuggestionsAdapter != null && (SearchView.this.mSuggestionsAdapter instanceof w)) {
        ...
        this.mTextWatcher = new TextWatcher() { // from class: android.support.v7.widget.SearchView.2
        ...
        android.support.v4.view.s.a(this.mSearchPlate, tintTypedArrayObtainStyledAttributes.getDrawable(a.j.SearchView_queryBackground));
        android.support.v4.view.s.a(this.mSubmitArea, tintTypedArrayObtainStyledAttributes.getDrawable(a.j.SearchView_submitBackground));
    ...
    public void setQueryRefinementEnabled(boolean z) {
        ...
        if (this.mSuggestionsAdapter instanceof w) {
            ((w) this.mSuggestionsAdapter).a(z ? 2 : 1);
        }
    }
    ...
    private void updateSearchAutoComplete() {
        ...
        if (this.mSuggestionsAdapter != null) {
            this.mSuggestionsAdapter.a((Cursor) null);
        }
        if (this.mSearchable.getSuggestAuthority() != null) {
            this.mSuggestionsAdapter = new w(getContext(), this, this.mSearchable, this.mOutsideDrawablesCache);
            this.mSearchSrcTextView.setAdapter(this.mSuggestionsAdapter);
            ((w) this.mSuggestionsAdapter).a(this.mQueryRefinement ? 2 : 1);
        }
    }
    ...
    static class SavedState extends AbsSavedState {
        ...
        public SavedState(Parcel parcel, ClassLoader classLoader) {
            ...
            this.f1559a = ((Boolean) parcel.readValue(null)).booleanValue();
        }

        @Override // android.support.v4.view.AbsSavedState, android.os.Parcelable
        public void writeToParcel(Parcel parcel, int i) {
            super.writeToParcel(parcel, i);
            parcel.writeValue(Boolean.valueOf(this.f1559a));
        }

        public String toString() {
            return "SearchView.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " isIconified=" + this.f1559a + "}";
        }
    }
    ...
    protected void onRestoreInstanceState(Parcelable parcelable) {
        ...
        updateViewsVisibility(savedState.f1559a);
        requestLayout();
    }
    ...
    private void rewriteQueryFromSuggestion(int i) {
        ...
        if (cursorA != null) {
            if (cursorA.moveToPosition(i)) {
                CharSequence charSequenceC = this.mSuggestionsAdapter.c(cursorA);
    ...
    private Intent createIntentFromSuggestion(Cursor cursor, int i, String str) {
        ...
        String strA;
        try {
            String strA2 = w.a(cursor, "suggest_intent_action");
            if (strA2 == null) {
            ...
            String strA3 = w.a(cursor, "suggest_intent_data");
            if (strA3 == null) {
                strA3 = this.mSearchable.getSuggestIntentData();
            }
            if (strA3 != null && (strA = w.a(cursor, "suggest_intent_data_id")) != null) {
                strA3 = strA3 + "/" + Uri.encode(strA);
            }
            return createIntent(strA2, strA3 == null ? null : Uri.parse(strA3), w.a(cursor, "suggest_intent_extra_data"), w.a(cursor, "suggest_intent_query"), i, str);
        } catch (RuntimeException e) {
            try {
    ...
    private static class b extends TouchDelegate {
        ...
        public void a(Rect rect, Rect rect2) {
            this.f1565b.set(rect);
            this.f1567d.set(rect);
            this.f1567d.inset(-this.e, -this.e);
            this.f1566c.set(rect2);
        }
        ...
        */
        public boolean onTouchEvent(android.view.MotionEvent r7) {
            ...
            L14:
                if (r2 == 0) goto L3b
                if (r1 == 0) goto L5b
                android.graphics.Rect r0 = r6.f1566c
                boolean r0 = r0.contains(r3, r4)
                if (r0 != 0) goto L5b
                android.view.View r0 = r6.f1564a
                int r0 = r0.getWidth()
                int r0 = r0 / 2
                float r0 = (float) r0
                android.view.View r1 = r6.f1564a
                int r1 = r1.getHeight()
                int r1 = r1 / 2
                float r1 = (float) r1
            ...
            L3b:
                return r0
            L3c:
                android.graphics.Rect r2 = r6.f1565b
            ...
            L48:
                boolean r2 = r6.f
                if (r2 == 0) goto L14
                android.graphics.Rect r5 = r6.f1567d
            ...
            L5b:
                ...
                int r0 = r3 - r0
                float r0 = (float) r0
                android.graphics.Rect r1 = r6.f1566c
                int r1 = r1.top
                int r1 = r4 - r1
                float r1 = (float) r1
                r7.setLocation(r0, r1)
    ...
    private static class a {
        ...
        a() {
            try {
                this.f1561a = AutoCompleteTextView.class.getDeclaredMethod("doBeforeTextChanged", new Class[0]);
                this.f1561a.setAccessible(true);
            } catch (NoSuchMethodException e) {
            }
            try {
                this.f1562b = AutoCompleteTextView.class.getDeclaredMethod("doAfterTextChanged", new Class[0]);
                this.f1562b.setAccessible(true);
            } catch (NoSuchMethodException e2) {
            }
            try {
                this.f1563c = AutoCompleteTextView.class.getMethod("ensureImeVisible", Boolean.TYPE);
                this.f1563c.setAccessible(true);
        ...
        void a(AutoCompleteTextView autoCompleteTextView) {
            if (this.f1561a != null) {
                try {
                    this.f1561a.invoke(autoCompleteTextView, new Object[0]);
                } catch (Exception e) {
                }
            }
        }
        ...
        void b(AutoCompleteTextView autoCompleteTextView) {
            if (this.f1562b != null) {
                try {
                    this.f1562b.invoke(autoCompleteTextView, new Object[0]);
                } catch (Exception e) {
                }
            }
        }
        ...
        void a(AutoCompleteTextView autoCompleteTextView, boolean z) {
            if (this.f1563c != null) {
                try {
                    this.f1563c.invoke(autoCompleteTextView, Boolean.valueOf(z));
                } catch (Exception e) {
                }
            }
        }
