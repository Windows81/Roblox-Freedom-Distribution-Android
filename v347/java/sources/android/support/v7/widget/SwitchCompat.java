...
public class SwitchCompat extends CompoundButton {
    ...
    public SwitchCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, a.j.SwitchCompat, i, 0);
        this.mThumbDrawable = tintTypedArrayObtainStyledAttributes.getDrawable(a.j.SwitchCompat_android_thumb);
        if (this.mThumbDrawable != null) {
            this.mThumbDrawable.setCallback(this);
        }
        this.mTrackDrawable = tintTypedArrayObtainStyledAttributes.getDrawable(a.j.SwitchCompat_track);
        if (this.mTrackDrawable != null) {
            this.mTrackDrawable.setCallback(this);
        }
        this.mTextOn = tintTypedArrayObtainStyledAttributes.getText(a.j.SwitchCompat_android_textOn);
        this.mTextOff = tintTypedArrayObtainStyledAttributes.getText(a.j.SwitchCompat_android_textOff);
        this.mShowText = tintTypedArrayObtainStyledAttributes.getBoolean(a.j.SwitchCompat_showText, true);
        this.mThumbTextPadding = tintTypedArrayObtainStyledAttributes.getDimensionPixelSize(a.j.SwitchCompat_thumbTextPadding, 0);
        this.mSwitchMinWidth = tintTypedArrayObtainStyledAttributes.getDimensionPixelSize(a.j.SwitchCompat_switchMinWidth, 0);
        this.mSwitchPadding = tintTypedArrayObtainStyledAttributes.getDimensionPixelSize(a.j.SwitchCompat_switchPadding, 0);
        this.mSplitTrack = tintTypedArrayObtainStyledAttributes.getBoolean(a.j.SwitchCompat_splitTrack, false);
        ColorStateList colorStateList = tintTypedArrayObtainStyledAttributes.getColorStateList(a.j.SwitchCompat_thumbTint);
        if (colorStateList != null) {
            this.mThumbTintList = colorStateList;
            this.mHasThumbTint = true;
        }
        PorterDuff.Mode tintMode = DrawableUtils.parseTintMode(tintTypedArrayObtainStyledAttributes.getInt(a.j.SwitchCompat_thumbTintMode, -1), null);
        ...
        ColorStateList colorStateList2 = tintTypedArrayObtainStyledAttributes.getColorStateList(a.j.SwitchCompat_trackTint);
        if (colorStateList2 != null) {
            this.mTrackTintList = colorStateList2;
            this.mHasTrackTint = true;
        }
        PorterDuff.Mode tintMode2 = DrawableUtils.parseTintMode(tintTypedArrayObtainStyledAttributes.getInt(a.j.SwitchCompat_trackTintMode, -1), null);
        ...
        int resourceId = tintTypedArrayObtainStyledAttributes.getResourceId(a.j.SwitchCompat_switchTextAppearance, 0);
        if (resourceId != 0) {
    ...
    public void setSwitchTextAppearance(Context context, int i) {
        ...
        ColorStateList colorStateList = tintTypedArrayObtainStyledAttributes.getColorStateList(a.j.TextAppearance_android_textColor);
        if (colorStateList != null) {
            this.mTextColors = colorStateList;
        } else {
            this.mTextColors = getTextColors();
        }
        int dimensionPixelSize = tintTypedArrayObtainStyledAttributes.getDimensionPixelSize(a.j.TextAppearance_android_textSize, 0);
        if (dimensionPixelSize != 0 && dimensionPixelSize != this.mTextPaint.getTextSize()) {
            this.mTextPaint.setTextSize(dimensionPixelSize);
            requestLayout();
        }
        setSwitchTypefaceByIndex(tintTypedArrayObtainStyledAttributes.getInt(a.j.TextAppearance_android_typeface, -1), tintTypedArrayObtainStyledAttributes.getInt(a.j.TextAppearance_android_textStyle, -1));
        if (tintTypedArrayObtainStyledAttributes.getBoolean(a.j.TextAppearance_textAllCaps, false)) {
            this.mSwitchTransformationMethod = new android.support.v7.e.a(getContext());
        } else {
        ...
        if (this.mTrackDrawable != null) {
            if (this.mHasTrackTint || this.mHasTrackTintMode) {
                ...
                if (this.mHasTrackTint) {
                    android.support.v4.b.a.a.a(this.mTrackDrawable, this.mTrackTintList);
                }
                if (this.mHasTrackTintMode) {
                    android.support.v4.b.a.a.a(this.mTrackDrawable, this.mTrackTintMode);
                }
        ...
        if (this.mThumbDrawable != null) {
            if (this.mHasThumbTint || this.mHasThumbTintMode) {
                ...
                if (this.mHasThumbTint) {
                    android.support.v4.b.a.a.a(this.mThumbDrawable, this.mThumbTintList);
                }
                if (this.mHasThumbTintMode) {
                    android.support.v4.b.a.a.a(this.mThumbDrawable, this.mThumbTintMode);
                }
    ...
    public void onMeasure(int i, int i2) {
        ...
        int iMax3 = Math.max(this.mSwitchMinWidth, iMax2 + iMax + (this.mThumbWidth * 2));
            ...
            case 2:
                switch (this.mTouchMode) {
                    ...
                    case 2:
                        ...
                        float fConstrain = constrain(f + this.mThumbPosition, 0.0f, 1.0f);
    ...
    public void setChecked(boolean z) {
        super.setChecked(z);
        boolean zIsChecked = isChecked();
        if (getWindowToken() != null && android.support.v4.view.s.v(this)) {
    ...
    public void drawableHotspotChanged(float f, float f2) {
        ...
        if (this.mThumbDrawable != null) {
            android.support.v4.b.a.a.a(this.mThumbDrawable, f, f2);
        }
        if (this.mTrackDrawable != null) {
            android.support.v4.b.a.a.a(this.mTrackDrawable, f, f2);
        }
    }
