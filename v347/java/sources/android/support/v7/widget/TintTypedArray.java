...
public class TintTypedArray {
    ...
    public Drawable getDrawable(int i) {
        int resourceId;
        return (!this.mWrapped.hasValue(i) || (resourceId = this.mWrapped.getResourceId(i, 0)) == 0) ? this.mWrapped.getDrawable(i) : android.support.v7.b.a.b.b(this.mContext, resourceId);
    }
    ...
    public Typeface getFont(int i, int i2, b.a aVar) {
        ...
        return android.support.v4.a.a.b.a(this.mContext, resourceId, this.mTypedValue, i2, aVar);
    }
    ...
    public ColorStateList getColorStateList(int i) {
        ...
        return (!this.mWrapped.hasValue(i) || (resourceId = this.mWrapped.getResourceId(i, 0)) == 0 || (colorStateListA = android.support.v7.b.a.b.a(this.mContext, resourceId)) == null) ? this.mWrapped.getColorStateList(i) : colorStateListA;
    }
