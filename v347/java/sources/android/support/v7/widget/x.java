...
class x {
    ...
    static final int[] f1724a = {-16842910};

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    static final int[] f1725b = {R.attr.state_focused};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    static final int[] f1726c = {R.attr.state_activated};

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    static final int[] f1727d = {R.attr.state_pressed};
    ...
    public static int a(Context context, int i2) {
        j[0] = i2;
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, (AttributeSet) null, j);
        try {
    ...
    public static int c(Context context, int i2) {
        ...
        if (colorStateListB != null && colorStateListB.isStateful()) {
            return colorStateListB.getColorForState(f1724a, colorStateListB.getDefaultColor());
        }
