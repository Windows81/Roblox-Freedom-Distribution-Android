...
public class a implements android.support.v4.c.a.b {
    ...
    private int i = RecyclerView.ItemAnimator.FLAG_APPEARED_IN_PRE_LAYOUT;
    private int k = RecyclerView.ItemAnimator.FLAG_APPEARED_IN_PRE_LAYOUT;
    private int m = 0;
    ...
    public MenuItem setIcon(int i) {
        this.m = i;
        this.l = android.support.v4.a.c.a(this.n, i);
        b();
        return this;
    }
    ...
    private void b() {
        if (this.l != null) {
            if (this.t || this.u) {
                this.l = android.support.v4.b.a.a.g(this.l);
