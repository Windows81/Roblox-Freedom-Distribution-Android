...
public class a extends android.support.v4.a.c {
    ...
    public static void a(final Activity activity, final String[] strArr, final int i) {
        if (f644a == null || !f644a.a(activity, strArr, i)) {
            if (Build.VERSION.SDK_INT >= 23) {
                if (activity instanceof c) {
                    ((c) activity).a(i);
                }
                activity.requestPermissions(strArr, i);
            } else if (activity instanceof InterfaceC0014a) {
                new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: android.support.v4.app.a.1
                    ...
                    public void run() {
                        ...
                        ((InterfaceC0014a) activity).onRequestPermissionsResult(i, strArr, iArr);
                    }
                });
            }
        }
