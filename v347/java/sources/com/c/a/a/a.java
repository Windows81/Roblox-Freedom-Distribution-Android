...
public final class a {
    ...
    private static final String[] f2431a = {"15555215554", "15555215556", "15555215558", "15555215560", "15555215562", "15555215564", "15555215566", "15555215568", "15555215570", "15555215572", "15555215574", "15555215576", "15555215578", "15555215580", "15555215582", "15555215584"};

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final String[] f2432b = {"000000000000000", "e21833235b6eef10", "012345678912345"};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final String[] f2433c = {"310260000000000"};

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static final String[] f2434d = {"/dev/socket/genyd", "/dev/socket/baseband_genyd"};
    ...
    /* JADX INFO: renamed from: com.c.a.a.a$a, reason: collision with other inner class name */
    ...
    public void a(final InterfaceC0053a interfaceC0053a) {
        new Thread(new Runnable() { // from class: com.c.a.a.a.1
            @Override // java.lang.Runnable
            public void run() {
                boolean zB = a.this.b();
                a.this.a("This System is Emulator: " + zB);
                if (interfaceC0053a != null) {
                    interfaceC0053a.a(zB);
                }
            }
        }).start();
    }
    ...
    private boolean d() {
        return f() || a(f2434d, "Geny") || a(h, "Andy") || a(i, "Nox") || k() || a(f, "Pipes") || m() || (l() && a(g, "X86"));
    }
    ...
    private boolean f() {
        if (c.a(k, "android.permission.READ_PHONE_STATE") == 0 && this.m && n()) {
            return g() || h() || i() || j();
        }
        return false;
    }
    ...
    private boolean l() {
        int i2 = 0;
        for (b bVar : j) {
            String strA = a(k, bVar.f2437a);
            if (bVar.f2438b == null && strA != null) {
                i2++;
            }
            if (bVar.f2438b != null && strA.contains(bVar.f2438b)) {
                i2++;
            }
        }
        if (i2 < 5) {
