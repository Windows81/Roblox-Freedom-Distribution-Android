...
public class b {
    ...
    private static void a(Context context, TextView textView, String str, String str2, String str3) {
        String strBaseUrl = RobloxSettings.baseUrl();
        int iIndexOf = str.indexOf(str2);
        int length = iIndexOf + str2.length();
        int iIndexOf2 = str.indexOf(str3);
        a(textView, str, new e(strBaseUrl + "info/terms-of-service", context, str2, iIndexOf, length), new e(strBaseUrl + "Info/Privacy?layout=null", context, str3, iIndexOf2, iIndexOf2 + str3.length()));
    }
        ...
        for (a aVar : aVarArr) {
            try {
                ...
                if (str.contains(strA)) {
                    ...
                    com.roblox.client.b.c.a("Substring: " + strA + ", is not part of string: " + str);
                }
    ...
    private static boolean a(ArrayList<a> arrayList, String str, int i, int i2) {
        for (int i3 = 0; i3 < arrayList.size() - 1; i3++) {
            ...
            if ((i >= iB && i <= iC) || (i2 >= iB && i2 <= iC)) {
                com.roblox.client.b.c.a("Substring: " + str.substring(i, i2) + ", overlaps with substring: " + strA);
                return true;
            }
        }
        return false;
