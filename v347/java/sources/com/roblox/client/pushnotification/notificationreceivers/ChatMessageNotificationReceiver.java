...
public class ChatMessageNotificationReceiver extends a {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (intent != null && "chat_message_replied".equals(intent.getAction())) {
            g.a("rbx.push", "CMNR.onReceive() INTENT_ACTION_CHAT_MESSAGE_REPLIED");
    ...
    private void a(long j, String str) {
        g.a("rbx.push", "In markChatNotificationAsRead(), conversationId: " + j + " ,messageId: " + str);
        com.roblox.client.i.g.a().a(new com.roblox.client.h.g(j, str, null));
    }

    private void a(final long j, String str, final Context context, final String str2, final String str3) {
        com.roblox.client.i.g.a().a(new h(j, str, new h.a() { // from class: com.roblox.client.pushnotification.notificationreceivers.ChatMessageNotificationReceiver.1
            ...
            public void a(String str4, String str5) {
                new com.roblox.client.pushnotification.h().a(context, str2, j, str3, "Moderated".equals(str4));
            }
        }));
    }
