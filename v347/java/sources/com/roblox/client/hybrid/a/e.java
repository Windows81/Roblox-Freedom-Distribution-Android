...
public class e extends com.roblox.a.c {
    ...
    class a implements c.a {
        ...
        void a(com.roblox.a.a aVar, org.greenrobot.eventbus.c cVar) {
            com.roblox.client.util.g.a("rbx.locale", "RBHybridModuleLocalization LanguageChangeTrigger.execute() " + aVar.c());
            String strOptString = aVar.c().optString("newRobloxLanguageValue");
            if (!TextUtils.isEmpty(strOptString)) {
                com.roblox.client.util.g.a("rbx.locale", "newRobloxLocaleValue " + strOptString);
                com.roblox.client.locale.c cVarA = com.roblox.client.locale.c.a(strOptString);
                if (cVarA != null) {
                    cVar.c(new com.roblox.client.e.b(cVarA));
                } else {
