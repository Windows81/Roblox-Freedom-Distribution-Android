...
public final class h {
    ...
    private static final Map<Class<?>, Class<?>> f6325a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final Map<Class<?>, Class<?>> f6326b;
    ...
    static {
        ...
        f6325a = Collections.unmodifiableMap(map);
        f6326b = Collections.unmodifiableMap(map2);
    }
    ...
    public static boolean a(Type type) {
        return f6325a.containsKey(type);
    }

    public static <T> Class<T> a(Class<T> cls) {
        Class<T> cls2 = (Class) f6325a.get(a.a(cls));
