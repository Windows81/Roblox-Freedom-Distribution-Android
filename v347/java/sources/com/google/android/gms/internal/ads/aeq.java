...
interface aeq {
    ...
    <K, V> void a(int i, acd<K, V> acdVar, Map<K, V> map) throws IOException;

    void a(int i, zv zvVar) throws IOException;

    void a(int i, Object obj) throws IOException;

    void a(int i, Object obj, add addVar) throws IOException;

    void a(int i, String str) throws IOException;

    void a(int i, List<String> list) throws IOException;

    void a(int i, List<?> list, add addVar) throws IOException;
    ...
    @Deprecated
    void b(int i, Object obj, add addVar) throws IOException;

    void b(int i, List<zv> list) throws IOException;

    @Deprecated
    void b(int i, List<?> list, add addVar) throws IOException;
