...
public final class i {
    ...
    private static final Map<Class<?>, Class<?>> f2714a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final Map<Class<?>, Class<?>> f2715b;
    ...
    static {
        ...
        f2714a = Collections.unmodifiableMap(map);
        f2715b = Collections.unmodifiableMap(map2);
    }
    ...
    public static boolean a(Type type) {
        return f2714a.containsKey(type);
    }

    public static <T> Class<T> a(Class<T> cls) {
        Class<T> cls2 = (Class) f2714a.get(a.a(cls));
